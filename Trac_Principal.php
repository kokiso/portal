...
<!-- 							<a href="#">
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li><a href="#" onclick="ifAbrir('Trac_FavorecidoGrupo.php' ,'jsPub[0].usr_d20','Parametro financeiro &nbsp&nbsp > &nbsp&nbsp Favorecido Grupo');"> <i class="fa fa-circle-o"></i> Favorecido_Grupo</a></li>
