<?php
  ...
  if( isset($_POST["grupoproduto"]) ){
    try{     
      ...
      $vldr     = new validaJson();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["grupoproduto"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        ////////////////////////////////////////////////
        if( $rotina=="selectGp" ){
          $sql="SELECT GP_CODIGO
                       ,GP_NOME
                       ,CASE WHEN A.GP_ORDEMSERVICO='S' THEN 'SIM' ELSE 'NAO' END AS GP_ORDEMSERVICO                       
                       ...
                       ,US_APELIDO
                       ,GP_CODUSR
                  FROM VGRUPOPRODUTO A
                  LEFT OUTER JOIN USUARIOSISTEMA U ON A.GP_CODUSR=U.US_CODIGO
                 WHERE ((GP_CODIGO<>'AUT') AND ((GP_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')))";
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VGRUPOPRODUTO",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        ///////////////////////////////////////////////
        //         Objeto clsTable2017 GRUPOPRODUTO  //
        ///////////////////////////////////////////////
        jsGp={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"GP_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do grupoproduto conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "GP_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do grupoproduto com até 20 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "GP_ORDEMSERVICO"  
                      ,"labelCol"       : "OS" 
                      ,"obj"            : "cbOs"
                      ,"tipo"           : "cb"                      
                      ,"tamGrd"         : "4em"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"digitosMinMax"  : [1,1]
                      ,"ajudaCampo"     : [ "Parametro para quando cadastrar este item sera impresso na OS"]
                      ,"popoverTitle"   : "Parametro informar este item sera impresso na OS(composição do auto)"                                            
                      ,"importaExcel"   : "S"                                                                
                      ,"padrao":0}                                                  
            ,{"id":4  ,"field"          : "GP_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"GRUPOPRODUTO - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmGp"                   // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaGp"                // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmGp"                   // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblGp"                   // Nome da table
          ,"prefixo"        : "Gp"                      // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VGRUPOPRODUTO"           // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPGRUPOPRODUTO"         // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "GP_ATIVO"                // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "GP_REG"                  // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "GP_CODUSR"               // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "82em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "GRUPOPRODUTO"            // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objGp.modeloExcel()"]                               
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objGp.AjudaSisAtivo(jsGp);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objGp.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objGp.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objGp.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objGp.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objGp.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"            ,"fa-info"          ,"objGp.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "GRUPOPRODUTO[33]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objGp === undefined ){  
          objGp=new clsTable2017("objGp");
        };  
        objGp.montarHtmlCE2017(jsGp); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsGp.form).style.width=jsGp.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação GRUPOPRODUTO" // Titulo do relatório
      ...
      //
      var objGp;                     // Obrigatório para instanciar o JS TFormaCob
      var jsGp;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        ...
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("grupoproduto" , clsJs.fim());
        msg     = requestPedido("Trac_GrupoProduto.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsGp.registros=objGp.addIdUnico(retPhp[0]["dados"]);
          objGp.ordenaJSon(jsGp.indiceTable,false);  
          objGp.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objGp.trazCampoExcel(jsGp)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("grupoproduto"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("Gp",retPhp[0].erro,{cabec:"Aviso"});    
          };  
        } catch(e){
      ...
      function btnConfirmarClick(){
        if( (document.getElementById("edtCodigo").value).toUpperCase()=="AUT" )
          gerarMensagemErro("cad","SIGLA AUT PERTENCENTE AO SISTEMA",{cabec:"Aviso"});            
        else
          objGp.gravar(true);  
      };  
    </script>
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Grupo de produto<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
          <div style="height: 120px; overflow-y: auto;">
            ...
            <div class="campotexto campo100">
              ...
              <div class="campotexto campo25">
                <select class="campo_input_combo" id="cbOs">
                  <option value="S">SIM</option>
                  <option value="N">NAO</option>
                </select>
                <label class="campo_label campo_required" for="cbOs">IMPRIMIR OS:</label>
              </div>
              <div class="campotexto campo15">
              ...
              <div onClick="btnConfirmarClick();" id="btnConfirmar" class="btnImagemEsq bie20 bieAzul bieRight"><i class="fa fa-check"> Confirmar</i></div>
