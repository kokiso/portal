<?php
  ...
  if( isset($_POST["moeda"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["moeda"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VMOEDA",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 MOEDA       //
        /////////////////////////////////////////////
        jsMoe={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"MOE_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do moeda conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "MOE_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do moeda com até 20 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "MOE_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":4  ,"field"          : "MOE_REG"    
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"MOEDA - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmMoe"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaMoe"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmMoe"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblMoe"                  // Nome da table
          ,"prefixo"        : "Moe"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VMOEDA"                  // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPMOEDA"                // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "MOE_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "MOE_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "MOE_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "77em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "MOEDA"                   // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objMoe.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objMoe.AjudaSisAtivo(jsMoe);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objMoe.detalhe();"]
                               //,["Gerar excel"                          ,"fa-file-excel-o"  ,"objMoe.excel();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objMoe.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objMoe.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objMoe.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objMoe.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"                ,"fa-info"      ,"objMoe.numRegistros();"]                               
        ...
        if( objMoe === undefined ){  
          objMoe=new clsTable2017("objMoe");
        };  
        objMoe.montarHtmlCE2017(jsMoe); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsMoe.form).style.width=jsMoe.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação MOEDA"        // Titulo do relatório
      ...
      //
      var objMoe;                     // Obrigatório para instanciar o JS TFormaCob
      var jsMoe;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectMoe"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("moeda" , clsJs.fim());
        msg     = requestPedido("Trac_Moeda.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsMoe.registros=objMoe.addIdUnico(retPhp[0]["dados"]);
          objMoe.ordenaJSon(jsMoe.indiceTable,false);  
          objMoe.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objMoe.trazCampoExcel(jsMoe)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("moeda"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("MOE",retPhp[0].erro,"AVISO");    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Moeda<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
