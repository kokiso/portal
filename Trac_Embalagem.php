<?php
  ...
  if( isset($_POST["embalagem"]) ){
    try{     
      ...
      $vldr     = new validaJson();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["embalagem"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectEmb" ){
          $sql="SELECT EMB_CODIGO
                 ...
                 WHERE (EMB_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VEMBALAGEM",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 EMBALAGEM   //
        /////////////////////////////////////////////
        jsEmb={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"EMB_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do embalagem conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "EMB_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do embalagem com até 30 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "EMB_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":4  ,"field"          : "EMB_REG"    
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"EMBALAGEM - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmEmb"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaEmb"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmEmb"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblEmb"                  // Nome da table
          ,"prefixo"        : "emb"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VEMBALAGEM"              // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPEMBALAGEM"            // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "EMB_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "EMB_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "EMB_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "77em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "EMBALAGEM"               // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objEmb.modeloExcel()"]                               
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objEmb.AjudaSisAtivo(jsEmb);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objEmb.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objEmb.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objEmb.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objEmb.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objEmb.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"                ,"fa-info"      ,"objEmb.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "EMBALAGEM[24]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objEmb === undefined ){  
          objEmb=new clsTable2017("objEmb");
        };  
        objEmb.montarHtmlCE2017(jsEmb); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsEmb.form).style.width=jsEmb.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação embalagem"    // Titulo do relatório
      ...
      //
      var objEmb;                     // Obrigatório para instanciar o JS TFormaCob
      var jsEmb;                      // Obj principal da classe clsTable2017
      ...
      var intCodDir = parseInt(jsPub[0].usr_d24);
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectEmb"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("embalagem" , clsJs.fim());
        msg     = requestPedido("Trac_Embalagem.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsEmb.registros=objEmb.addIdUnico(retPhp[0]["dados"]);
          objEmb.ordenaJSon(jsEmb.indiceTable,false);  
          objEmb.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objEmb.trazCampoExcel(jsEmb)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("embalagem"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("EMB",retPhp[0].erro,{cabec:"Aviso"});    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Embalagem<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
