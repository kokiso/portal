<?php
  ...
  if( isset($_POST["tipodocumento"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["tipodocumento"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        ////////////////////////////////////////////////
        if( $rotina=="selectTd" ){
          $sql="SELECT TD_CODIGO
                       ,TD_NOME
                       ,CASE WHEN A.TD_SERIENF='P' THEN CAST('PRODUTO' AS VARCHAR(7))
                             WHEN A.TD_SERIENF='S' THEN CAST('SERVICO' AS VARCHAR(7))
                             WHEN A.TD_SERIENF='N' THEN CAST('NSA' AS VARCHAR(3)) END AS TD_SERIENF
                 ...
                 WHERE (TD_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VTIPODOCUMENTO",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 tipodocumento       //
        /////////////////////////////////////////////
        jsTd={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"TD_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do tipodocumento conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "TD_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do tipodocumento com até 20 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "TD_SERIENF"  
                      ,"labelCol"       : "TALONARIO" 
                      ...
                      ,"validar"        : ["notnull"]
                      ,"digitosMinMax"  : [1,1]
                      ,"funcCor"        : "( objCell.innerHTML=='NSA' ? objCell.classList.add('corFonteAlterado') : objCell.classList.remove('corFonteAlterado'))"
                      ,"ajudaCampo"     : [ "Informa se o tipo de documento é referente a serviço, produto ou nao se aplica"]
                      ,"importaExcel"   : "S"                                                                
                      ,"padrao":0}                                                  
            ,{"id":4  ,"field"          : "TD_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"TIPODOCUMENTO - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmTd"                   // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaTd"                // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmTd"                   // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblTd"                   // Nome da table
          ,"prefixo"        : "td"                      // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VTIPODOCUMENTO"          // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPTIPODOCUMENTO"        // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "TD_ATIVO"                // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "TD_REG"                  // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "TD_CODUSR"               // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "77em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "TIPODOCUMENTO"           // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objTd.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objTd.AjudaSisAtivo(jsTd);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objTd.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objTd.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objTd.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objTd.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objTd.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"            ,"fa-info"          ,"objTd.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "TIPODOCUMENTO[20]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objTd === undefined ){  
          objTd=new clsTable2017("objTd");
        };  
        objTd.montarHtmlCE2017(jsTd); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsTd.form).style.width=jsTd.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          "titulo":[
            ...
            ,{"id":2  ,"field":"SERIENF"    ,"labelCol":"TALONARIO_REF" ,"tamGrd":"6em"   ,"tamImp":"20"}
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação TIPODOCUMENTO"// Titulo do relatório
      ...
      //
      var objTd;                     // Obrigatório para instanciar o JS TFormaCob
      var jsTd;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectTd"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("tipodocumento" , clsJs.fim());
        msg     = requestPedido("Trac_Tipodocumento.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsTd.registros=objTd.addIdUnico(retPhp[0]["dados"]);
          objTd.ordenaJSon(jsTd.indiceTable,false);  
          objTd.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objTd.trazCampoExcel(jsTd)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("tipodocumento"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("TD",retPhp[0].erro,"AVISO");    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Tipo docto<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
          <div style="height: 120px; overflow-y: auto;">
            ...
            <div class="campotexto campo100">
              ...
              <div class="campotexto campo35">
                <select class="campo_input_combo" id="cbSerieNf">
                  <option value="P">PRODUTO</option>
                  <option value="S">SERVICO</option>
                  <option value="N">NSA</option>
                </select>
                <label class="campo_label" for="cbSerieNf">TALONARIO</label>
              </div>
              <div class="campotexto campo15">
