<?php
  ...
  if( isset($_POST["categoria"]) ){
    try{     
      ...
      $vldr     = new validaJson();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["categoria"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        ////////////////////////////////////////////////
        if( $rotina=="selectCtg" ){
          $sql="SELECT CTG_CODIGO
                       ,CTG_NOME
                       ,CASE WHEN A.CTG_FISJUR='F' THEN CAST('FIS' AS VARCHAR(3)) WHEN A.CTG_FISJUR='J' THEN CAST('JUR' AS VARCHAR(3)) ELSE CAST('FJ' AS VARCHAR(2)) END AS CTG_FISJUR                       
                 ...
                 WHERE (CTG_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VCATEGORIA",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //      Objeto clsTable2017 CATEGORIA      //
        /////////////////////////////////////////////
        jsCtg={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"CTG_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo da categoria conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "CTG_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome da categoria com até 20 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "CTG_FISJUR"  
                      ,"labelCol"       : "FJ"   
                      ,"insUpDel"       : ["S","S","N"]         
                      ...
                      ,"digitosMinMax"  : [1,2]
                      ,"digitosValidos" : "F|J"
                      ,"ajudaCampo"     : [ "Fisica ou juridica."]
                      ,"importaExcel"   : "S"                                           
                      ,"padrao":0}                                        
            ,{"id":4  ,"field"          : "CTG_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":5  ,"field"          : "CTG_REG"    
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"CATEGORIA - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmCtg"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaCtg"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmCtg"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblCtg"                  // Nome da table
          ,"prefixo"        : "Ctg"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VCATEGORIA"              // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPCATEGORIA"            // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "CTG_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "CTG_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "CTG_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "80em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "CATEGORIA"               // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objCtg.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objCtg.AjudaSisAtivo(jsCtg);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objCtg.detalhe();"]
                               //,["Gerar excel"                            ,"fa-file-excel-o"  ,"objCtg.excel();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objCtg.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objCtg.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objCtg.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objCtg.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"                ,"fa-info"      ,"objCtg.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "CATEGORIA[12]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objCtg === undefined ){  
          objCtg=new clsTable2017("objCtg");
        };  
        objCtg.montarHtmlCE2017(jsCtg); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsCtg.form).style.width=jsCtg.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          "titulo":[
            ...
            ,{"id":1  ,"field":"DESCRICAO"  ,"labelCol":"DESCRICAO" ,"tamGrd":"20em" ,"tamImp":"100"}
            ,{"id":2  ,"field":"FJ"         ,"labelCol":"FJ"        ,"tamGrd":"2em"  ,"tamImp":"10"}
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação categoria"    // Titulo do relatório
      ...
      //
      var objCtg;                     // Obrigatório para instanciar o JS TFormaCob
      var jsCtg;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectCtg"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("categoria" , clsJs.fim());
        msg     = requestPedido("Trac_Categoria.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsCtg.registros=objCtg.addIdUnico(retPhp[0]["dados"]);
          objCtg.ordenaJSon(jsCtg.indiceTable,false);  
          objCtg.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        //fncLerExcel.call(objCtg,jsCtg,'categoria');
        try{
          clsErro = new clsMensagem("Erro");
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objCtg.trazCampoExcel(jsCtg)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("categoria"   , envPhp              );
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Categoria<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
          <div style="height: 160px; overflow-y: auto;">
            ...
            <div class="campotexto campo100">
              ...
              <div class="campotexto campo25">
                ...
                <label class="campo_label campo_required" for="cbFisJur">FISICA/JURIDICA</label>
              </div>
              <div class="campotexto campo25">
