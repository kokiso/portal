<?php
  ...
  if( isset($_POST["formacobranca"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["formacobranca"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectFc" ){
          $sql="SELECT FC_CODIGO
                       ...
                       ,US_APELIDO
                       ,FC_CODUSR
                  FROM FORMACOBRANCA A
                  LEFT OUTER JOIN USUARIOSISTEMA U ON A.FC_CODUSR=U.US_CODIGO
                 WHERE (FC_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VFORMACOBRANCA",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 FORMACOBRANCA       //
        /////////////////////////////////////////////
        jsFc={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"FC_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do formacobranca conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "FC_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do formacobranca com até 20 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "FC_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"FORMACOBRANCA - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"tabelaBD"       : "VFORMACOBRANCA"          // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPFORMACOBRANCA"        // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "FC_ATIVO"                // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "FC_REG"                  // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "FC_CODUSR"               // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "77em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "FORMA COBRANCA"          // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objFc.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objFc.AjudaSisAtivo(jsFc);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objFc.detalhe();"]
                               //,["Gerar excel"                            ,"fa-file-excel-o"  ,"objFc.excel();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objFc.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objFc.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objFc.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objFc.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"            ,"fa-info"          ,"objFc.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "FORMACOBRANCA[20]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objFc === undefined ){  
        ...
        //////////////////////////////////    
        document.getElementById(jsFc.form).style.width=jsFc.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação formacobranca" // Titulo do relatório
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectFc"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("formacobranca" , clsJs.fim());
        msg     = requestPedido("Trac_FormaCobranca.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          objFc.ordenaJSon(jsFc.indiceTable,false);  
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objFc.trazCampoExcel(jsFc)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("formacobranca"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("FC",retPhp[0].erro,"AVISO");    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Forma cobrança<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
