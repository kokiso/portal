<?php
  ...
  if( isset($_POST["cstpis"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["cstpis"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectPis" ){
          $sql="SELECT PIS_CODIGO
                 ...
                 WHERE (PIS_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VCSTPIS",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 CSTPIS      //
        /////////////////////////////////////////////
        jsPis={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"PIS_CODIGO" 
                      ,"pk"             : "S"            
                      ,"insUpDel"       : ["S","N","N"]                      
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do cstpis conforme definição empresa. Este campo é único e deve tem o formato AAA"
                                            ,"Campo pode ser utilizado em cadastros de Usuario/Motorista"]
                      ,"importaExcel"   : "S"                                                                
                      ,"padrao":0}
            ,{"id":2  ,"field"          : "PIS_ENTSAI"  
                      ,"pk"             : "S"          
                      ,"insUpDel"       : ["S","N","N"]                      
                      ,"labelCol"       : "ES" 
                      ,"obj"            : "cbEntSai"
            ...
            ,{"id":3  ,"field"          : "PIS_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do cstpis com até 60 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":4  ,"field"          : "PIS_SNALIQ"  
                      ,"labelCol"       : "SNALIQ" 
                      ,"obj"            : "cbSnAliq"
                      ,"tipo"           : "cb"                      
                      ,"tamGrd"         : "3em"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"digitosMinMax"  : [1,1]
                      ,"ajudaCampo"     : [ "Alíquita Pis..."]
                      ,"importaExcel"   : "S"                                                                
                      ,"padrao":0}                                                  
            ,{"id":5  ,"field"          : "PIS_PCISENTAS"  
                      ,"labelCol"       : "ISENTAS%" 
            ...
            ,{"id":8 ,"field"          : "PIS_REG"    
                      ...
                      ,"padrao":3}  
            ,{"id":9  ,"field"          : "PIS_APELIDO" 
                      ,"labelCol"       : "USUARIO" 
                      ,"obj"            : "edtUsuario" 
                      ,"padrao":4}                
            ,{"id":10 ,"field"          : "PIS_CODUSR" 
                      ,"labelCol"       : "CODUSU"  
                      ,"obj"            : "edtCodUsu"  
                      ,"padrao":5}                                      
            ,{"id":11 ,"labelCol"       : "PP"      
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"CSTPIS - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmPis"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaPis"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmPis"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblPis"                  // Nome da table
          ,"prefixo"        : "pis"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VCSTPIS"                 // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPCSTPIS"               // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "PIS_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "PIS_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "PIS_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "112em"                   // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "CSTPIS"                  // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objPis.modeloExcel()"]                               
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objPis.AjudaSisAtivo(jsPis);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objPis.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objPis.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objPis.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objPis.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objPis.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"            ,"fa-info"          ,"objPis.numRegistros();"]                               
        ...
        if( objPis === undefined ){  
          objPis=new clsTable2017("objPis");
        };  
        objPis.montarHtmlCE2017(jsPis); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsPis.form).style.width=jsPis.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação CSTPIS"       // Titulo do relatório
          ,"relOrientacao"  : "P"                       // Paisagem ou retrato
      ...
      //
      var objPis;                     // Obrigatório para instanciar o JS TFormaCob
      var jsPis;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectPis"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("cstpis" , clsJs.fim());
        msg     = requestPedido("Trac_CstPis.php",fd);
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsPis.registros=objPis.addIdUnico(retPhp[0]["dados"]);
          objPis.ordenaJSon(jsPis.indiceTable,false);  
          objPis.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objPis.trazCampoExcel(jsPis)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("cstpis"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("PIS",retPhp[0].erro,{cabec:"Aviso"});    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Cst-Pis<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
          <div style="height: 160px; overflow-y: auto;">
            ...
            <div class="campotexto campo100">
              ...
              <div class="campotexto campo20">
                ...
                <label class="campo_label campo_required" for="cbSnAliq">ALIQ PIS</label>
              </div>
              <div class="campotexto campo20">
