<?php
  ...
  if( isset($_POST["pontoestoque"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["pontoestoque"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        ////////////////////////////////////////////////
        if( $rotina=="selectPe" ){
          $sql="SELECT PE_CODIGO
                       ,PE_NOME
                       ,CASE WHEN A.PE_SUCATA='S' THEN 'SIM' ELSE 'NAO' END AS PE_SUCATA                       
                 ...
                 WHERE (PE_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VPONTOESTOQUE",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        ///////////////////////////////////////////////
        //         Objeto clsTable2017 PONTOESTOQUE  //
        ///////////////////////////////////////////////
        jsPe={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"PE_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do pontoestoque conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "PE_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do pontoestoque com até 20 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "PE_SUCATA"  
                      ,"labelCol"       : "SUCATA" 
                      ,"obj"            : "cbSucata"
                      ,"tipo"           : "cb"                      
                      ,"tamGrd"         : "3em"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"digitosMinMax"  : [1,1]
                      ,"ajudaCampo"     : [ "Se pode ser alterado para sucata"]
                      ,"popoverTitle"   : "Informa se neste ponto de estoque pode ser transformado em sucata"                          
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"PONTOESTOQUE - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmPe"                   // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaPe"                // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmPe"                   // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblPe"                   // Nome da table
          ,"prefixo"        : "Pe"                      // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VPONTOESTOQUE"           // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPPONTOESTOQUE"         // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "PE_ATIVO"                // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "PE_REG"                  // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "PE_CODUSR"               // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "80em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "PONTOESTOQUE"            // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objPe.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objPe.AjudaSisAtivo(jsPe);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objPe.detalhe();"]
                               //,["Gerar excel"                          ,"fa-file-excel-o"  ,"objPe.excel();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objPe.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objPe.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objPe.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objPe.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"                ,"fa-info"      ,"objPe.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "PONTOESTOQUE[33]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objPe === undefined ){  
          objPe=new clsTable2017("objPe");
        };  
        objPe.montarHtmlCE2017(jsPe); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsPe.form).style.width=jsPe.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação PONTOESTOQUE" // Titulo do relatório
      ...
      //
      var objPe;                     // Obrigatório para instanciar o JS TFormaCob
      var jsPe;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectPe"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("pontoestoque" , clsJs.fim());
        msg     = requestPedido("Trac_PontoEstoque.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsPe.registros=objPe.addIdUnico(retPhp[0]["dados"]);
          objPe.ordenaJSon(jsPe.indiceTable,false);  
          objPe.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objPe.trazCampoExcel(jsPe)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("pontoestoque"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("Pe",retPhp[0].erro,"AVISO");    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Ponto estoque<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>
          <div style="height: 110px; overflow-y: auto;">
            ...
            <div class="campotexto campo100">
              ...
              <div class="campotexto campo20">
                <select class="campo_input_combo" id="cbSucata">
                  <option value="S">SIM</option>
                  <option value="N">NAO</option>
                </select>
                <label class="campo_label campo_required" for="cbSucata">EM SUCATA</label>
              </div>
              <div class="campotexto campo20">
              ...
              <div class="inactive">
                ...
                <input id="edtEstoque" value="0" type="text" />                
              </div>
