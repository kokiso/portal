function fBkp_GrupoProduto(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpGp={
      ...
      ,"relTitulo"      : "ESPIAO - GRUPOPRODUTO"         // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpGp === undefined ){          
      objBkpGp=new clsTable2017("objBkpGp");
    };  
    objBkpGp.montarHtmlCE2017(jsBkpGp);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpGp.registros=objBkpGp.addIdUnico(retPhp[0]["dados"]);
    objBkpGp.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpGp.tbl).colAlterada();
  };  
};
