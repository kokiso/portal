function fBkp_Balanco(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpBln={
      ...
      ,"relTitulo"      : "ESPIAO - BALANCO"    // Titulo do relatório
      ,"relOrientacao"  : "P"                   // Paisagem ou retrato
      ,"relFonte"       : "8"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpBln === undefined ){          
      objBkpBln=new clsTable2017("objBkpBln");
    };  
    objBkpBln.montarHtmlCE2017(jsBkpBln);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpBln.registros=objBkpBln.addIdUnico(retPhp[0]["dados"]);
    objBkpBln.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpBln.tbl).colAlterada();
  };  
};
