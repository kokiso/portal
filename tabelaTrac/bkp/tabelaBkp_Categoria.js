function fBkp_Categoria(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpCtg={
      ...
      ,"relTitulo"      : "ESPIAO - CATEGORIA"  // Titulo do relatório
      ,"relOrientacao"  : "R"                   // Paisagem ou retrato
      ,"relFonte"       : "8"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpCtg === undefined ){          
      objBkpCtg=new clsTable2017("objBkpCtg");
    };  
    objBkpCtg.montarHtmlCE2017(jsBkpCtg);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpCtg.registros=objBkpCtg.addIdUnico(retPhp[0]["dados"]);
    objBkpCtg.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpCtg.tbl).colAlterada();
  };  
};