function fBkp_VeiculoModelo(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpVmd={
      ...
      ,"relTitulo"      : "ESPIAO - VEICULO MODELO"       // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpVmd === undefined ){          
      objBkpVmd=new clsTable2017("objBkpVmd");
    };  
    objBkpVmd.montarHtmlCE2017(jsBkpVmd);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpVmd.registros=objBkpVmd.addIdUnico(retPhp[0]["dados"]);
    objBkpVmd.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpVmd.tbl).colAlterada();
  };  
};