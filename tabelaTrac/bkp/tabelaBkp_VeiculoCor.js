function fBkp_VeiculoCor(whr,exc){
  "use strict";
  ...
  clsJs   = jsString("lote");  
  clsJs.add("rotina"      , "selectBkpVeiculoCor" );
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpVcr={
      ...
      ,"relTitulo"      : "ESPIAO - COR" 	      // Titulo do relatório
      ,"relOrientacao"  : "R"                   // Paisagem ou retrato
      ,"relFonte"       : "8"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpVcr === undefined ){          
      objBkpVcr=new clsTable2017("objBkpVcr");
    };  
    objBkpVcr.montarHtmlCE2017(jsBkpVcr);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpVcr.registros=objBkpVcr.addIdUnico(retPhp[0]["dados"]);
    objBkpVcr.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpVcr.tbl).colAlterada();
  };  
};