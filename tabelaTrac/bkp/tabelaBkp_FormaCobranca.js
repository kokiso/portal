function fBkp_FormaCobranca(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpFc={
      ...
      ,"relTitulo"      : "ESPIAO - FORMACOBRANCA"        // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpFc === undefined ){          
      objBkpFc=new clsTable2017("objBkpFc");
    };  
    objBkpFc.montarHtmlCE2017(jsBkpFc);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpFc.registros=objBkpFc.addIdUnico(retPhp[0]["dados"]);
    objBkpFc.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpFc.tbl).colAlterada();
  };  
};
