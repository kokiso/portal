function fBkp_Operadora(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpOpe={
      ...
      ,"width"          : "60em"                          // Tamanho da table
      ,"height"         : "53em"                          // Altura da table
      ,"relTitulo"      : "ESPIAO - OPERADORA"            // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpOpe === undefined ){          
      objBkpOpe=new clsTable2017("objBkpOpe");
    };  
    objBkpOpe.montarHtmlCE2017(jsBkpOpe);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpOpe.registros=objBkpOpe.addIdUnico(retPhp[0]["dados"]);
    objBkpOpe.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpOpe.tbl).colAlterada();
  };  
};
