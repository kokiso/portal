function fBkp_EmpresaTipo(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpEtp={
      ...
      ,"relTitulo"      : "ESPIAO - EMPRESATIPO"                // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpEtp === undefined ){          
      objBkpEtp=new clsTable2017("objBkpEtp");
    };  
    objBkpEtp.montarHtmlCE2017(jsBkpEtp);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpEtp.registros=objBkpEtp.addIdUnico(retPhp[0]["dados"]);
    objBkpEtp.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpEtp.tbl).colAlterada();
  };  
};
