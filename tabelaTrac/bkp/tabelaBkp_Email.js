function fBkp_Email(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpEma={
      ...
      ,"relTitulo"      : "ESPIAO - EMAIL"                // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpEma === undefined ){          
      objBkpEma=new clsTable2017("objBkpEma");
    };  
    objBkpEma.montarHtmlCE2017(jsBkpEma);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpEma.registros=objBkpEma.addIdUnico(retPhp[0]["dados"]);
    objBkpEma.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpEma.tbl).colAlterada();
  };  
};
