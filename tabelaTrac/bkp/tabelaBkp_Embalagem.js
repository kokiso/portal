function fBkp_Embalagem(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpEmb={
      ...
      ,"relTitulo"      : "ESPIAO - EMBALAGEM"                // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpEmb === undefined ){          
      objBkpEmb=new clsTable2017("objBkpEmb");
    };  
    objBkpEmb.montarHtmlCE2017(jsBkpEmb);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpEmb.registros=objBkpEmb.addIdUnico(retPhp[0]["dados"]);
    objBkpEmb.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpEmb.tbl).colAlterada();
  };  
};
