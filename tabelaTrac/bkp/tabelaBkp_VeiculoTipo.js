function fBkp_VeiculoTipo(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    if( objBkpVtp === undefined ){          
      objBkpVtp=new clsTable2017("objBkpVtp");
    };  
    objBkpVtp.montarHtmlCE2017(jsBkpVtp);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpVtp.registros=objBkpVtp.addIdUnico(retPhp[0]["dados"]);
    objBkpVtp.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpVtp.tbl).colAlterada();
  };  
};