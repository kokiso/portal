function fBkp_Estado(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpEst={
      ...
      ,"relTitulo"      : "ESPIAO - ESTADO"     // Titulo do relatório
      ,"relOrientacao"  : "R"                   // Paisagem ou retrato
      ,"relFonte"       : "8"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpEst === undefined ){          
      objBkpEst=new clsTable2017("objBkpEst");
    };  
    objBkpEst.montarHtmlCE2017(jsBkpEst);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpEst.registros=objBkpEst.addIdUnico(retPhp[0]["dados"]);
    objBkpEst.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpEst.tbl).colAlterada();
  };  
};