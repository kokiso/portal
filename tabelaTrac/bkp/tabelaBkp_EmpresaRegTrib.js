function fBkp_EmpresaRegTrib(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpErt={
      ...
      ,"relTitulo"      : "ESPIAO - EMPRESAREGTRIB"       // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpErt === undefined ){          
      objBkpErt=new clsTable2017("objBkpErt");
    };  
    objBkpErt.montarHtmlCE2017(jsBkpErt);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpErt.registros=objBkpErt.addIdUnico(retPhp[0]["dados"]);
    objBkpErt.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpErt.tbl).colAlterada();
  };  
};
