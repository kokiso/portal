function fBkp_PontoEstoque(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpPe={
      ...
      ,"relTitulo"      : "ESPIAO - PONTOESTOQUE"         // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpPe === undefined ){          
      objBkpPe=new clsTable2017("objBkpPe");
    };  
    objBkpPe.montarHtmlCE2017(jsBkpPe);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpPe.registros=objBkpPe.addIdUnico(retPhp[0]["dados"]);
    objBkpPe.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpPe.tbl).colAlterada();
  };  
};
