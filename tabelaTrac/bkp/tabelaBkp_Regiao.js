function fBkp_Regiao(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpReg={
      ...
      ,"relTitulo"      : "ESPIAO - REGIAO"     // Titulo do relatório
      ,"relOrientacao"  : "R"                   // Paisagem ou retrato
      ,"relFonte"       : "8"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpReg === undefined ){          
      objBkpReg=new clsTable2017("objBkpReg");
    };  
    objBkpReg.montarHtmlCE2017(jsBkpReg);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpReg.registros=objBkpReg.addIdUnico(retPhp[0]["dados"]);
    objBkpReg.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpReg.tbl).colAlterada();
  };  
};