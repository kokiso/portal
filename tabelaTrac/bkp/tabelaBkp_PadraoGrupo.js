function fBkp_PadraoGrupo(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpPg={
      ...
      ,"checarTags"     : "S"                   // Somente em tPgo de desenvolvimento(olha as pricipais tags)                        
      ...
      ,"relTitulo"      : "ESPIAO - PADRAOGRUPO"// Titulo do relatório
      ,"relOrientacao"  : "R"                   // Paisagem ou retrato
      ,"relFonte"       : "8"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpPg === undefined ){          
      objBkpPg=new clsTable2017("objBkpPg");
    };  
    objBkpPg.montarHtmlCE2017(jsBkpPg);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpPg.registros=objBkpPg.addIdUnico(retPhp[0]["dados"]);
    objBkpPg.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpPg.tbl).colAlterada();
  };  
};
