function fBkp_PagarTipo(whr,exc){
  "use strict";
    ...
    var jsBkpPtp={
      "titulo":[
        ...
        ,{"id":4  ,"labelCol":"DESCRICAO"
                  ...
                  ,"tamImp":"57"
                  ,"padrao":9}
        ,{"id":5  ,"labelCol":"VALOR","tamGrd":"3em","tamImp":"10","labelColImp":"VLR","padrao":9}
        ,{"id":6  ,"labelCol":"CNAB","tamGrd":"3em","tamImp":"12","labelColImp":"CNAB","padrao":9}
        ,{"id":7  ,"labelCol":"CONTABIL","tamGrd":"3em","tamImp":"10","labelColImp":"CTB","padrao":9}        
        ,{"id":8  ,"labelCol":"REG"
                  ,"tamGrd":"4em"
                  ,"tamImp":"10"
                  ,"padrao":9}
      ...
      ,"width"          : "81em"                          // Tamanho da table
      ,"height"         : "53em"                          // Altura da table
      ,"relTitulo"      : "ESPIAO - PAGARTIPO"            // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpPtp === undefined ){          
      objBkpPtp=new clsTable2017("objBkpPtp");
    };  
    objBkpPtp.montarHtmlCE2017(jsBkpPtp);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpPtp.registros=objBkpPtp.addIdUnico(retPhp[0]["dados"]);
    objBkpPtp.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpPtp.tbl).colAlterada();
  };  
};
