function fBkp_CstPis(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpPis={
      ...
      ,"relTitulo"      : "ESPIAO - CSTPIS"               // Titulo do relatório
      ,"relOrientacao"  : "P"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpPis === undefined ){          
      objBkpPis=new clsTable2017("objBkpPis");
    };  
    objBkpPis.montarHtmlCE2017(jsBkpPis);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpPis.registros=objBkpPis.addIdUnico(retPhp[0]["dados"]);
    objBkpPis.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpPis.tbl).colAlterada();
  };  
};
