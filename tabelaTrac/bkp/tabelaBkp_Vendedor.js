function fBkp_Vendedor(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpVnd={
      ...
      ,"relTitulo"      : "ESPIAO - VENDEDOR"             // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpVnd === undefined ){          
      objBkpVnd=new clsTable2017("objBkpVnd");
    };  
    objBkpVnd.montarHtmlCE2017(jsBkpVnd);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpVnd.registros=objBkpVnd.addIdUnico(retPhp[0]["dados"]);
    objBkpVnd.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpVnd.tbl).colAlterada();
  };  
};
