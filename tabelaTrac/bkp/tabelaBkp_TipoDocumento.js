function fBkp_TipoDocumento(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpTd={
      ...
      ,"relTitulo"      : "ESPIAO - TIPODOCUMENTO"        // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpTd === undefined ){          
      objBkpTd=new clsTable2017("objBkpTd");
    };  
    objBkpTd.montarHtmlCE2017(jsBkpTd);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpTd.registros=objBkpTd.addIdUnico(retPhp[0]["dados"]);
    objBkpTd.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpTd.tbl).colAlterada();
  };  
};
