function fBkp_Feriado(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpFrd={
      ...
      ,"width"          : "89em"                // Tamanho da table
      ,"height"         : "53em"                // Altura da table
      ,"relTitulo"      : "ESPIAO - FERIADO"    // Titulo do relatório
      ,"relOrientacao"  : "R"                   // Paisagem ou retrato
      ,"relFonte"       : "7"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpFrd === undefined ){          
      objBkpFrd=new clsTable2017("objBkpFrd");
    };  
    objBkpFrd.montarHtmlCE2017(jsBkpFrd);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpFrd.registros=objBkpFrd.addIdUnico(retPhp[0]["dados"]);
    objBkpFrd.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpFrd.tbl).colAlterada();
  };  
};
