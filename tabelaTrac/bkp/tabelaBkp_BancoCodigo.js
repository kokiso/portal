function fBkp_BancoCodigo(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpBcd={
      ...
      ,"relTitulo"      : "ESPIAO - BANCOCODIGO"          // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpBcd === undefined ){          
      objBkpBcd=new clsTable2017("objBkpBcd");
    };  
    objBkpBcd.montarHtmlCE2017(jsBkpBcd);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpBcd.registros=objBkpBcd.addIdUnico(retPhp[0]["dados"]);
    objBkpBcd.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpBcd.tbl).colAlterada();
  };  
};
