function fBkp_QualificacaoCont(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpQc={
      ...
      ,"relTitulo"      : "ESPIAO - QUALIFICACAOCONT"                // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpQc === undefined ){          
      objBkpQc=new clsTable2017("objBkpQc");
    };  
    objBkpQc.montarHtmlCE2017(jsBkpQc);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpQc.registros=objBkpQc.addIdUnico(retPhp[0]["dados"]);
    objBkpQc.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpQc.tbl).colAlterada();
  };  
};
