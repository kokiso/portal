function fBkp_EmpresaRamo(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpErm={
      ...
      ,"relTitulo"      : "ESPIAO - EMPRESARAMO"                // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpErm === undefined ){          
      objBkpErm=new clsTable2017("objBkpErm");
    };  
    objBkpErm.montarHtmlCE2017(jsBkpErm);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpErm.registros=objBkpErm.addIdUnico(retPhp[0]["dados"]);
    objBkpErm.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpErm.tbl).colAlterada();
  };  
};
