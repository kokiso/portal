function fBkp_Logradouro(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpLgr={
      ...
      ,"relTitulo"      : "ESPIAO - LOGRADOURO" // Titulo do relatório
      ,"relOrientacao"  : "R"                   // Paisagem ou retrato
      ,"relFonte"       : "8"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpLgr === undefined ){          
      objBkpLgr=new clsTable2017("objBkpLgr");
    };  
    objBkpLgr.montarHtmlCE2017(jsBkpLgr);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpLgr.registros=objBkpLgr.addIdUnico(retPhp[0]["dados"]);
    objBkpLgr.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpLgr.tbl).colAlterada();
  };  
};