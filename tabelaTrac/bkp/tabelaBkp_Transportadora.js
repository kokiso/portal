function fBkp_Transportadora(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpTrn={
      ...
      ,"relTitulo"      : "ESPIAO - TRANSPORTADORA"       // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpTrn === undefined ){          
      objBkpTrn=new clsTable2017("objBkpTrn");
    };  
    objBkpTrn.montarHtmlCE2017(jsBkpTrn);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpTrn.registros=objBkpTrn.addIdUnico(retPhp[0]["dados"]);
    objBkpTrn.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpTrn.tbl).colAlterada();
  };  
};
