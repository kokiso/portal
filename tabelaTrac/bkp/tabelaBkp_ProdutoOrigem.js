function fBkp_ProdutoOrigem(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpPo={
      ...
      ,"relTitulo"      : "ESPIAO - PRODUTOORIGEM"        // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpPo === undefined ){          
      objBkpPo=new clsTable2017("objBkpPo");
    };  
    objBkpPo.montarHtmlCE2017(jsBkpPo);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpPo.registros=objBkpPo.addIdUnico(retPhp[0]["dados"]);
    objBkpPo.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpPo.tbl).colAlterada();
  };  
};
