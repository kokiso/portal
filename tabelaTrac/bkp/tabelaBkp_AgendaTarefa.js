function fBkp_AgendaTarefa(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpAt={
      ...
      ,"relTitulo"      : "ESPIAO - AGENDATAREFA"                // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpAt === undefined ){          
      objBkpAt=new clsTable2017("objBkpAt");
    };  
    objBkpAt.montarHtmlCE2017(jsBkpAt);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpAt.registros=objBkpAt.addIdUnico(retPhp[0]["dados"]);
    objBkpAt.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpAt.tbl).colAlterada();
  };  
};
