    ...
    var jsBkpFll={
      "titulo":[
        ...
        ,{"id":9  ,"labelCol":"CODCDD"
                  ...
                  ,"tamImp":"15"
                  ,"padrao":9}
        ,{"id":10  ,"labelCol":"CODLGR"
                  ,"tamGrd":"5em"
                  ,"tamImp":"0"
                  ,"padrao":9}
        ,{"id":11  ,"labelCol":"ENDERECO"
                  ,"tamGrd":"20em"
                  ,"tamImp":"0"
                  ,"padrao":9}
        ,{"id":12  ,"labelCol":"NUMERO"
                  ,"tamGrd":"5em"
                  ,"tamImp":"0"
                  ,"padrao":9}
        ,{"id":13  ,"labelCol":"FONE"
        ...
        ,{"id":14  ,"labelCol":"INS"
                  ...
                  ,"tamImp":"0"
                  ,"padrao":9}
        ,{"id":15  ,"labelCol":"INSCMUNIC"
                  ,"tamGrd":"10em"
                  ,"tamImp":"0"
                  ,"padrao":9}
        ,{"id":16  ,"labelCol":"CODEMP"
                  ,"tamGrd":"5em"
                  ,"tamImp":"15"
                  ,"padrao":9}
        ,{"id":17  ,"labelCol":"REG"
                  ...
                  ,"tamImp":"12"
                  ,"padrao":9}
        ,{"id":18  ,"labelCol":"ATIVO"
                  ,"tamGrd":"4em"
                  ,"tamImp":"15"
                  ,"padrao":9}
        ,{"id":19 ,"labelCol":"USUARIO"
                  ,"tamGrd":"10em"
                  ,"tamImp":"30"
                  ,"classe":"escondeA"
                  ,"padrao":9}
      ...
      ,"relTitulo"      : "ESPIAO - FILIAL" 	// Titulo do relatório
      ,"relOrientacao"  : "P"                   // Paisagem ou retrato
      ,"relFonte"       : "8"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpFll === undefined ){          
      objBkpFll=new clsTable2017("objBkpFll");
    };  
    objBkpFll.montarHtmlCE2017(jsBkpFll);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpFll.registros=objBkpFll.addIdUnico(retPhp[0]["dados"]);
    objBkpFll.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpFll.tbl).colAlterada();
  };  
};
