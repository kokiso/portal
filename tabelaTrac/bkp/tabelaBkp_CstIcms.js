function fBkp_CstIcms(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpIcm={
      ...
      ,"relTitulo"      : "ESPIAO - CSTICMS"              // Titulo do relatório
      ,"relOrientacao"  : "P"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpIcm === undefined ){          
      objBkpIcm=new clsTable2017("objBkpIcm");
    };  
    objBkpIcm.montarHtmlCE2017(jsBkpIcm);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpIcm.registros=objBkpIcm.addIdUnico(retPhp[0]["dados"]);
    objBkpIcm.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpIcm.tbl).colAlterada();
  };  
};