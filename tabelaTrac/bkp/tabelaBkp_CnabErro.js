function fBkp_CnabErro(whr,exc){
  "use strict";
    ...
    var jsBkpErr={
      "titulo":[
        ...
        ,{"id":4  ,"labelCol":"TP"
                  ...
                  ,"tamImp":"10"
                  ,"padrao":9}
        ,{"id":5  ,"labelCol":"CODIGO"
                  ,"tamGrd":"8em"
                  ,"tamImp":"18"
                  ,"padrao":9}
        ,{"id":6  ,"labelCol":"DESCRICAO"
                  ,"tamGrd":"40em"
                  ,"truncate":"S" 
                  ,"tamImp":"140"
                  ,"padrao":9}
      ...
      ,"relTitulo"      : "ESPIAO - CNABERRO"   // Titulo do relatório
      ,"relOrientacao"  : "P"                   // Paisagem ou retrato
      ,"relFonte"       : "7"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpErr === undefined ){          
      objBkpErr=new clsTable2017("objBkpErr");
    };  
    objBkpErr.montarHtmlCE2017(jsBkpErr);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpErr.registros=objBkpErr.addIdUnico(retPhp[0]["dados"]);
    objBkpErr.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpErr.tbl).colAlterada();
  };  
};