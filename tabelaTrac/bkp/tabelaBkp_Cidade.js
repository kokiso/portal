    ...
    var jsBkpCdd={
      "titulo":[
        ...
        ,{"id":6  ,"labelCol":"DDD"
                  ...
                  ,"tamImp":"10"
                  ,"padrao":9}
        ,{"id":7  ,"labelCol":"LATITUDE"
                  ,"tamGrd":"8em"
                  ,"tamImp":"20"
                  ,"fieldType":"flo8"
                  ,"padrao":9}
        ,{"id":8  ,"labelCol":"LONGITUDE"
                  ,"tamGrd":"8em"
                  ,"tamImp":"20"
                  ,"fieldType":"flo8"                  
                  ,"padrao":9}
      ...
      ,"relTitulo"      : "ESPIAO - CLIENTE"    // Titulo do relatório
      ,"relOrientacao"  : "P"                   // Paisagem ou retrato
      ,"relFonte"       : "8"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpCdd === undefined ){          
      objBkpCdd=new clsTable2017("objBkpCdd");
    };  
    objBkpCdd.montarHtmlCE2017(jsBkpCdd);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpCdd.registros=objBkpCdd.addIdUnico(retPhp[0]["dados"]);
    objBkpCdd.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpCdd.tbl).colAlterada();
  };  
};