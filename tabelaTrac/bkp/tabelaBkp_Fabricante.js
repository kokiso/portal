function fBkp_Fabricante(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpFbc={
      ...
      ,"width"          : "58em"                          // Tamanho da table
      ,"height"         : "53em"                          // Altura da table
      ,"relTitulo"      : "ESPIAO - FABRICANTE"           // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpFbc === undefined ){          
      objBkpFbc=new clsTable2017("objBkpFbc");
    };  
    objBkpFbc.montarHtmlCE2017(jsBkpFbc);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpFbc.registros=objBkpFbc.addIdUnico(retPhp[0]["dados"]);
    objBkpFbc.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpFbc.tbl).colAlterada();
  };  
};
