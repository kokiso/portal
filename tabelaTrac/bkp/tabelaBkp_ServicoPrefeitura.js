function fBkp_ServicoPrefeitura(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpSpr={
      ...
      ,"relTitulo"      : "ESPIAO - SERVICOPREFEITURA"    // Titulo do relatório
      ,"relOrientacao"  : "P"                   // Paisagem ou retrato
      ,"relFonte"       : "7"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpSpr === undefined ){          
      objBkpSpr=new clsTable2017("objBkpSpr");
    };  
    objBkpSpr.montarHtmlCE2017(jsBkpSpr);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpSpr.registros=objBkpSpr.addIdUnico(retPhp[0]["dados"]);
    objBkpSpr.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpSpr.tbl).colAlterada();
  };  
};
