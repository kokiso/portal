function fBkp_VeiculoFabricante(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpVfb={
      ...
      ,"relTitulo"      : "ESPIAO - VEICULO TIPO"         // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpVfb === undefined ){          
      objBkpVfb=new clsTable2017("objBkpVfb");
    };  
    objBkpVfb.montarHtmlCE2017(jsBkpVfb);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpVfb.registros=objBkpVfb.addIdUnico(retPhp[0]["dados"]);
    objBkpVfb.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpVfb.tbl).colAlterada();
  };  
};