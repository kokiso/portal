function fBkp_Competencia(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpCmp={
      ...
      ,"width"          : "83em"                // Tamanho da table
      ,"height"         : "53em"                // Altura da table
      ,"relTitulo"      : "ESPIAO - COMPETENCIA"// Titulo do relatório
      ,"relOrientacao"  : "P"                   // Paisagem ou retrato
      ,"relFonte"       : "7"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpCmp === undefined ){          
      objBkpCmp=new clsTable2017("objBkpCmp");
    };  
    objBkpCmp.montarHtmlCE2017(jsBkpCmp);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpCmp.registros=objBkpCmp.addIdUnico(retPhp[0]["dados"]);
    objBkpCmp.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpCmp.tbl).colAlterada();
  };  
};