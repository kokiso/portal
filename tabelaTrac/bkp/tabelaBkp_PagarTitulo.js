function fBkp_PagarTitulo(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpPtt={
      ...
      ,"relTitulo"      : "ESPIAO - PAGARTITULO"          // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpPtt === undefined ){          
      objBkpPtt=new clsTable2017("objBkpPtt");
    };  
    objBkpPtt.montarHtmlCE2017(jsBkpPtt);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpPtt.registros=objBkpPtt.addIdUnico(retPhp[0]["dados"]);
    objBkpPtt.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpPtt.tbl).colAlterada();
  };  
};
