function fBkp_BancoStatus(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpBst={
      ...
      ,"relTitulo"      : "ESPIAO - BANCOSTATUS"          // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpBst === undefined ){          
      objBkpBst=new clsTable2017("objBkpBst");
    };  
    objBkpBst.montarHtmlCE2017(jsBkpBst);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpBst.registros=objBkpBst.addIdUnico(retPhp[0]["dados"]);
    objBkpBst.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpBst.tbl).colAlterada();
  };  
};
