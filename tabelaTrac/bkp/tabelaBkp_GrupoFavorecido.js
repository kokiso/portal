function fBkp_GrupoFavorecido(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpGf={
      ...
      ,"relTitulo"      : "ESPIAO - GRUPOFAVORECIDO"      // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpGf === undefined ){          
      objBkpGf=new clsTable2017("objBkpGf");
    };  
    objBkpGf.montarHtmlCE2017(jsBkpGf);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpGf.registros=objBkpGf.addIdUnico(retPhp[0]["dados"]);
    objBkpGf.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpGf.tbl).colAlterada();
  };  
};
