function fBkp_Sped(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpSpd={
      ...
      ,"relTitulo"      : "ESPIAO - SPED"                 // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpSpd === undefined ){          
      objBkpSpd=new clsTable2017("objBkpSpd");
    };  
    objBkpSpd.montarHtmlCE2017(jsBkpSpd);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpSpd.registros=objBkpSpd.addIdUnico(retPhp[0]["dados"]);
    objBkpSpd.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpSpd.tbl).colAlterada();
  };  
};
