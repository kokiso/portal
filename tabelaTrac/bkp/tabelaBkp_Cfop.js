    ...
    var jsBkpCfo={
      "titulo":[
        ...
        ,{"id":4  ,"labelCol":"DESCRICAO"
                  ...
                  ,"tamImp":"112"
                  ,"padrao":9}
        ,{"id":5  ,"labelCol":"ES","tamGrd":"3em","tamImp":"10","padrao":9}
        ,{"id":6  ,"labelCol":"RELCOMPRA","tamGrd":"9em","tamImp":"20","padrao":9}
        ,{"id":7  ,"labelCol":"RELVENDA","tamGrd":"8em","tamImp":"20","padrao":9}        
        ,{"id":8  ,"labelCol":"REG"
                  ,"tamGrd":"3em"
                  ,"tamImp":"10"
                  ,"padrao":9}
      ...
      ,"relTitulo"      : "ESPIAO - CFOP"                 // Titulo do relatório
      ,"relOrientacao"  : "P"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpCfo === undefined ){          
      objBkpCfo=new clsTable2017("objBkpCfo");
    };  
    objBkpCfo.montarHtmlCE2017(jsBkpCfo);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpCfo.registros=objBkpCfo.addIdUnico(retPhp[0]["dados"]);
    objBkpCfo.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpCfo.tbl).colAlterada();
  };  
};
