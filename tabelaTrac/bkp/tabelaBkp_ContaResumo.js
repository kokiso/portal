function fBkp_ContaResumo(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpCtr={
      ...
      ,"relTitulo"      : "ESPIAO - CONTARESUMO"          // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpCtr === undefined ){          
      objBkpCtr=new clsTable2017("objBkpCtr");
    };  
    objBkpCtr.montarHtmlCE2017(jsBkpCtr);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpCtr.registros=objBkpCtr.addIdUnico(retPhp[0]["dados"]);
    objBkpCtr.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpCtr.tbl).colAlterada();
  };  
};