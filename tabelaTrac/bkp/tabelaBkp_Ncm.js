function fBkp_Ncm(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpNcm={
      ...
      ,"relTitulo"      : "ESPIAO - NCM"                // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpNcm === undefined ){          
      objBkpNcm=new clsTable2017("objBkpNcm");
    };  
    objBkpNcm.montarHtmlCE2017(jsBkpNcm);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpNcm.registros=objBkpNcm.addIdUnico(retPhp[0]["dados"]);
    objBkpNcm.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpNcm.tbl).colAlterada();
  };  
};
