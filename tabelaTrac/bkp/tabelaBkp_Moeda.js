function fBkp_Moeda(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpMoe={
      ...
      ,"relTitulo"      : "ESPIAO - MOEDA"                // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpMoe === undefined ){          
      objBkpMoe=new clsTable2017("objBkpMoe");
    };  
    objBkpMoe.montarHtmlCE2017(jsBkpMoe);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpMoe.registros=objBkpMoe.addIdUnico(retPhp[0]["dados"]);
    objBkpMoe.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpMoe.tbl).colAlterada();
  };  
};
