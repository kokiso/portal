function fBkp_NaturezaOperacao(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpNo={
      ...
      ,"relTitulo"      : "ESPIAO - NATUREZAOPERACAO"     // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpNo === undefined ){          
      objBkpNo=new clsTable2017("objBkpNo");
    };  
    objBkpNo.montarHtmlCE2017(jsBkpNo);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpNo.registros=objBkpNo.addIdUnico(retPhp[0]["dados"]);
    objBkpNo.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpNo.tbl).colAlterada();
  };  
};
