function fBkp_CstIpi(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpIpi={
      ...
      ,"relTitulo"      : "ESPIAO - CSTIPI"               // Titulo do relatório
      ,"relOrientacao"  : "P"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpIpi === undefined ){          
      objBkpIpi=new clsTable2017("objBkpIpi");
    };  
    objBkpIpi.montarHtmlCE2017(jsBkpIpi);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpIpi.registros=objBkpIpi.addIdUnico(retPhp[0]["dados"]);
    objBkpIpi.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpIpi.tbl).colAlterada();
  };  
};