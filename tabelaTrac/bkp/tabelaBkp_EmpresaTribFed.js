function fBkp_EmpresaTribFed(whr,exc){
  "use strict";
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpEtf={
      ...
      ,"relTitulo"      : "ESPIAO - EMPRESATRIBFED"       // Titulo do relatório
      ,"relOrientacao"  : "R"                             // Paisagem ou retrato
      ,"relFonte"       : "8"                             // Fonte do relatório
      ,"indiceTable"    : "ID"                            // Indice inicial da table
      ,"tamBotao"       : "15"                            // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpEtf === undefined ){          
      objBkpEtf=new clsTable2017("objBkpEtf");
    };  
    objBkpEtf.montarHtmlCE2017(jsBkpEtf);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpEtf.registros=objBkpEtf.addIdUnico(retPhp[0]["dados"]);
    objBkpEtf.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpEtf.tbl).colAlterada();
  };  
};
