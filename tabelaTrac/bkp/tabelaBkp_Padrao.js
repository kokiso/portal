function fBkp_Padrao(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpPdr={
      ...
      ,"width"          : "85e m"               // Tamanho da table
      ,"height"         : "53em"                // Altura da table
      ,"relTitulo"      : "ESPIAO - PADRAO" 	// Titulo do relatório
      ,"relOrientacao"  : "R"                   // Paisagem ou retrato
      ,"relFonte"       : "8"                   // Fonte do relatório
      ,"indiceTable"    : "ID"                  // Indice inicial da table
      ,"tamBotao"       : "15"                  // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpPdr === undefined ){          
      objBkpPdr=new clsTable2017("objBkpPdr");
    };  
    objBkpPdr.montarHtmlCE2017(jsBkpPdr);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpPdr.registros=objBkpPdr.addIdUnico(retPhp[0]["dados"]);
    objBkpPdr.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpPdr.tbl).colAlterada();
  };  
};