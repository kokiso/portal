function fBkp_Pais(whr,exc){
  ...
  if( retPhp[0].retorno == "OK" ){
    ...
    var jsBkpPai={
      ...
      ,"relTitulo"      : "ESPIAO - PAIS"   // Titulo do relatório
      ,"relOrientacao"  : "R"               // Paisagem ou retrato
      ,"relFonte"       : "8"               // Fonte do relatório
      ,"indiceTable"    : "ID"              // Indice inicial da table
      ,"tamBotao"       : "15"              // Tamanho botoes defalt 12 [12/25/50/75/100]
    }; 
    if( objBkpPai === undefined ){          
      objBkpPai=new clsTable2017("objBkpPai");
    };  
    objBkpPai.montarHtmlCE2017(jsBkpPai);
    /////////////////////////////////////
    // Enchendo a grade com registros  //   
    /////////////////////////////////////
    jsBkpPai.registros=objBkpPai.addIdUnico(retPhp[0]["dados"]);
    objBkpPai.montarBody2017();
    /////////////////////////////////////
    //   Marcando os campos alterados  //   
    /////////////////////////////////////
    if( exc.toUpperCase()=='N' )
      document.getElementById(jsBkpPai.tbl).colAlterada();
  };  
};