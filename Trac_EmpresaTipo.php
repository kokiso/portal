<?php
  ...
  if( isset($_POST["empresatipo"]) ){
    try{     
      ...
      $vldr     = new validaJson();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["empresatipo"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectEtp" ){
          $sql="SELECT ETP_CODIGO
                 ...
                 WHERE (ETP_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VEMPRESATIPO",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 EMPRESATIPO //
        /////////////////////////////////////////////
        jsEtp={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"ETP_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do empresatipo conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "ETP_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do empresatipo com até 20 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "ETP_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":4  ,"field"          : "ETP_REG"    
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"EMPRESATIPO - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmEtp"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaEtp"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmEtp"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblEtp"                  // Nome da table
          ,"prefixo"        : "etp"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VEMPRESATIPO"            // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPEMPRESATIPO"          // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "ETP_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "ETP_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "ETP_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "77em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "EMPRESATIPO"             // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objEtp.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objEtp.AjudaSisAtivo(jsEtp);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objEtp.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objEtp.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objEtp.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objEtp.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objEtp.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"                ,"fa-info"      ,"objEtp.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "EMPRESATIPO[25]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objEtp === undefined ){  
          objEtp=new clsTable2017("objEtp");
        };  
        objEtp.montarHtmlCE2017(jsEtp); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsEtp.form).style.width=jsEtp.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação empresatipo"  // Titulo do relatório
      ...
      //
      var objEtp;                     // Obrigatório para instanciar o JS TFormaCob
      var jsEtp;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectEtp"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("empresatipo" , clsJs.fim());
        msg     = requestPedido("Trac_EmpresaTipo.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsEtp.registros=objEtp.addIdUnico(retPhp[0]["dados"]);
          objEtp.ordenaJSon(jsEtp.indiceTable,false);  
          objEtp.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objEtp.trazCampoExcel(jsEtp)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("empresatipo"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("ETP",retPhp[0].erro,{cabec:"Aviso"});    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Empresa-Tipo<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
