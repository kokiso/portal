<?php
  ...
  if( isset($_POST["bancostatus"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["bancostatus"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectBst" ){
          $sql="SELECT BST_CODIGO
                 ...
                 WHERE (BST_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VBANCOSTATUS",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 BANCOSTATUS //
        /////////////////////////////////////////////
        jsBst={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"BST_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do bancostatus conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "BST_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do bancostatus com até 20 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "BST_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":4  ,"field"          : "BST_REG"    
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"BANCOSTATUS - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmBst"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaBst"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmBst"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblBst"                  // Nome da table
          ,"prefixo"        : "bst"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VBANCOSTATUS"            // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPBANCOSTATUS"          // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "BST_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "BST_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "BST_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "75em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "BANCO-STATUS"            // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objBst.modeloExcel()"]                               
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objBst.AjudaSisAtivo(jsBst);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objBst.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objBst.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objBst.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objBst.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objBst.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"            ,"fa-info"          ,"objBst.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "BANCOSTATUS[06]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objBst === undefined ){  
          objBst=new clsTable2017("objBst");
        };  
        objBst.montarHtmlCE2017(jsBst); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsBst.form).style.width=jsBst.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação bancostatus"  // Titulo do relatório
      ...
      //
      var objBst;                     // Obrigatório para instanciar o JS TFormaCob
      var jsBst;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectBst"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("bancostatus" , clsJs.fim());
        msg     = requestPedido("Trac_BancoStatus.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsBst.registros=objBst.addIdUnico(retPhp[0]["dados"]);
          objBst.ordenaJSon(jsBst.indiceTable,false);  
          objBst.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objBst.trazCampoExcel(jsBst)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("bancostatus"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("BST",retPhp[0].erro,{cabec:"Aviso"});    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Banco status<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
