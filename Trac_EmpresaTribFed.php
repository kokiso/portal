<?php
  ...
  if( isset($_POST["empresatribfed"]) ){
    try{     
      ...
      $vldr     = new validaJson();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["empresatribfed"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectEtf" ){
          $sql="SELECT ETF_CODIGO
                       ...
                       ,US_APELIDO
                       ,ETF_CODUSR
                  FROM EMPRESATRIBFED A
                  LEFT OUTER JOIN USUARIOSISTEMA U ON A.ETF_CODUSR=U.US_CODIGO
                 WHERE (ETF_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VEMPRESATRIBFED",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        ////////////////////////////////////////////////
        //         Objeto clsTable2017 EMPRESATRIBFED //
        ////////////////////////////////////////////////
        jsEtf={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"ETF_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do empresatribfed conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "ETF_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do empresatribfed com até 20 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "ETF_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":4  ,"field"          : "ETF_REG"    
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"EMPRESATRIBFED - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmEtf"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaEtf"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmEtf"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblEtf"                  // Nome da table
          ,"prefixo"        : "etf"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VEMPRESATRIBFED"         // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPEMPRESATRIBFED"       // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "ETF_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "ETF_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "ETF_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "77em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "EMPRESATRIBFED"          // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objEtr.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objEtf.AjudaSisAtivo(jsEtf);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objEtf.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objEtf.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objEtf.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objEtf.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objEtf.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"                ,"fa-info"      ,"objEtf.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "EMPRESATRIBFED[25]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objEtf === undefined ){  
          objEtf=new clsTable2017("objEtf");
        };  
        objEtf.montarHtmlCE2017(jsEtf); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsEtf.form).style.width=jsEtf.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação empresatribfed" // Titulo do relatório
      ...
      //
      var objEtf;                     // Obrigatório para instanciar o JS TFormaCob
      var jsEtf;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectEtf"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("empresatribfed" , clsJs.fim());
        msg     = requestPedido("Trac_EmpresaTribFed.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsEtf.registros=objEtf.addIdUnico(retPhp[0]["dados"]);
          objEtf.ordenaJSon(jsEtf.indiceTable,false);  
          objEtf.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objEtf.trazCampoExcel(jsEtf)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("empresatribfed"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("ETF",retPhp[0].erro,{cabec:"Aviso"});    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Empresa Trib Fed<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
