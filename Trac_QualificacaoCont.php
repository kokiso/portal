<?php
  session_start();
  if( isset($_POST["qualificacaocont"]) ){
    try{     
      ...
      $vldr     = new validaJson();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["qualificacaocont"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectQc" ){
          $sql="SELECT QC_CODIGO
                       ...
                       ,US_APELIDO
                       ,QC_CODUSR
                  FROM QUALIFICACAOCONT A
                  LEFT OUTER JOIN USUARIOSISTEMA U ON A.QC_CODUSR=U.US_CODIGO
                 WHERE (QC_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VQUALIFICACAOCONT",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 QUALIFICACAOCONT       //
        /////////////////////////////////////////////
        jsQc={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"QC_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do qualificacaocont conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "QC_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do qualificacaocont com até 70 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "QC_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"QUALIFICACAOCONT - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmQc"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaQc"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmQc"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblQc"                  // Nome da table
          ,"prefixo"        : "qc"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VQUALIFICACAOCONT"      // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPQUALIFICACAOCONT"    // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "QC_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "QC_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "QC_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "90em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "QUALIFICACAOCONT"        // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objQc.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objQc.AjudaSisAtivo(jsQc);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objQc.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objQc.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objQc.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objQc.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objQc.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"                ,"fa-info"      ,"objQc.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "QUALIFICACAOCONT[70]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objQc === undefined ){  
          objQc=new clsTable2017("objQc");
        };  
        objQc.montarHtmlCE2017(jsQc); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsQc.form).style.width=jsQc.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          "titulo":[
            ...
            ,{"id":1  ,"field":"DESCRICAO"  ,"labelCol":"DESCRICAO" ,"tamGrd":"35em" ,"tamImp":"100"}
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação QUALIFICACAOCONT"// Titulo do relatório
      ...
      //
      var objQc;                     // Obrigatório para instanciar o JS TFormaCob
      var jsQc;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectQc"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("qualificacaocont" , clsJs.fim());
        msg     = requestPedido("Trac_Qualificacaocont.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsQc.registros=objQc.addIdUnico(retPhp[0]["dados"]);
          objQc.ordenaJSon(jsQc.indiceTable,false);  
          objQc.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          clsErro = new clsMensagem("Erro");
          clsErro.notNull("ARQUIVO"       ,edtQcArquivo.value);
          if( clsErro.ListaErr() != "" ){
            clsErro.Show();
          } else {
            clsJs   = jsString("lote");  
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objQc.trazCampoExcel(jsQc)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("qualificacaocont"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("QC",retPhp[0].erro,"AVISO");    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Qualificação cont<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
          <div style="height: 120px; overflow-y: auto;">
            ...
            <div class="campotexto campo100">
              ...
              <div class="campotexto campo75">
                <input class="campo_input" id="edtDescricao" type="text" maxlength="70" />
