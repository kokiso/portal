<?php
  ...
  if( isset($_POST["cstipi"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["cstipi"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectIpi" ){
          $sql="SELECT IPI_CODIGO
                 ...
                 WHERE (IPI_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VCSTIPI",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 CSTIPI      //
        /////////////////////////////////////////////
        jsIpi={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"IPI_CODIGO" 
                      ,"pk"             : "S"            
                      ,"insUpDel"       : ["S","N","N"]                      
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do cstipi conforme definição empresa. Este campo é único e deve tem o formato AAA"
                                            ,"Campo pode ser utilizado em cadastros de Usuario/Motorista"]
                      ,"importaExcel"   : "S"                                                                
                      ,"padrao":0}
            ,{"id":2  ,"field"          : "IPI_ENTSAI"  
                      ,"pk"             : "S"          
                      ,"insUpDel"       : ["S","N","N"]                      
                      ,"labelCol"       : "ES" 
                      ,"obj"            : "cbEntSai"
            ...
            ,{"id":3  ,"field"          : "IPI_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do cstipi com até 60 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":4  ,"field"          : "IPI_SNALIQ"  
                      ,"labelCol"       : "SNALIQ" 
                      ,"obj"            : "cbSnAliq"
                      ,"tipo"           : "cb"                      
                      ,"tamGrd"         : "3em"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"digitosMinMax"  : [1,1]
                      ,"ajudaCampo"     : [ "Alíquita Ipi..."]
                      ,"importaExcel"   : "S"                                                                
                      ,"padrao":0}                                                  
            ,{"id":5  ,"field"          : "IPI_PCISENTAS"  
                      ,"labelCol"       : "ISENTAS%" 
                      ,"obj"            : "edtPcIsentas"
            ...
            ,{"id":8 ,"field"          : "IPI_REG"    
                      ...
                      ,"padrao":3}  
            ,{"id":9  ,"field"          : "IPI_APELIDO" 
                      ,"labelCol"       : "USUARIO" 
                      ,"obj"            : "edtUsuario" 
                      ,"padrao":4}                
            ,{"id":10 ,"field"          : "IPI_CODUSR" 
                      ,"labelCol"       : "CODUSU"  
                      ,"obj"            : "edtCodUsu"  
                      ,"padrao":5}                                      
            ,{"id":11 ,"labelCol"       : "PP"      
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"CSTIPI - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmIpi"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaIpi"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmIpi"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblIpi"                  // Nome da table
          ,"prefixo"        : "ipi"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VCSTIPI"                 // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPCSTIPI"               // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "IPI_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "IPI_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "IPI_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "113em"                   // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "CSTIPI"                  // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objIpi.modeloExcel()"]                               
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objIpi.AjudaSisAtivo(jsIpi);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objIpi.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objIpi.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objIpi.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objIpi.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objIpi.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"            ,"fa-info"          ,"objIpi.numRegistros();"]                               
        ...
        if( objIpi === undefined ){  
          objIpi=new clsTable2017("objIpi");
        };  
        objIpi.montarHtmlCE2017(jsIpi); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsIpi.form).style.width=jsIpi.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          "titulo":[
            ...
            ,{"id":6  ,"field":"ERRO"       ,"labelCol":"ERRO"      ,"tamGrd":"35em"  ,"tamImp":"100"}
          ]
          ,"botoesH":[
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação cstipi"       // Titulo do relatório
          ,"relOrientacao"  : "P"                       // Paisagem ou retrato
      ...
      //
      var objIpi;                     // Obrigatório para instanciar o JS TFormaCob
      var jsIpi;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectIpi"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("cstipi" , clsJs.fim());
        msg     = requestPedido("Trac_CstIpi.php",fd);
		console.log(msg);
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsIpi.registros=objIpi.addIdUnico(retPhp[0]["dados"]);
          objIpi.ordenaJSon(jsIpi.indiceTable,false);  
          objIpi.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objIpi.trazCampoExcel(jsIpi)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("cstipi"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("IPI",retPhp[0].erro,{cabec:"Aviso"});    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Cst-Ipi<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
          <div style="height: 160px; overflow-y: auto;">
            ...
            <div class="campotexto campo100">
              ...
              <div class="campotexto campo20">
                ...
                <label class="campo_label campo_required" for="cbSnAliq">ALIQ IPI</label>
              </div>
              <div class="campotexto campo20">
