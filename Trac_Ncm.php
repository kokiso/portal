<?php
  ...
  if( isset($_POST["ncm"]) ){
    try{     
      ...
      $vldr     = new validaJson();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["ncm"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VNCM",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 NCM       //
        /////////////////////////////////////////////
        jsNcm={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"NCM_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "7em"
                      ,"tamImp"         : "17"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do ncm conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "NCM_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do ncm com até 60 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "NCM_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":4  ,"field"          : "NCM_REG"    
          ...
          ,"div"            : "frmNcm"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaNcm"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmNcm"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblNcm"                  // Nome da table
          ,"prefixo"        : "ncm"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VNCM"                    // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPNCM"                  // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "NCM_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "NCM_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "NCM_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "77em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "NCM"                     // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objNcm.modeloExcel()"]                               
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objNcm.AjudaSisAtivo(jsNcm);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objNcm.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objNcm.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objNcm.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objNcm.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objNcm.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"            ,"fa-info"          ,"objNcm.numRegistros();"]                               
        ...
        if( objNcm === undefined ){  
          objNcm=new clsTable2017("objNcm");
        };  
        objNcm.montarHtmlCE2017(jsNcm); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsNcm.form).style.width=jsNcm.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação NCM"          // Titulo do relatório
      ...
      //
      var objNcm;                     // Obrigatório para instanciar o JS TFormaCob
      var jsNcm;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectNcm"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("ncm" , clsJs.fim());
        msg     = requestPedido("Trac_Ncm.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsNcm.registros=objNcm.addIdUnico(retPhp[0]["dados"]);
          objNcm.ordenaJSon(jsNcm.indiceTable,false);  
          objNcm.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          clsErro = new clsMensagem("Erro");
          clsErro.notNull("ARQUIVO"       ,edtNcmArquivo.value);
          if( clsErro.ListaErr() != "" ){
            clsErro.Show();
          } else {
            clsJs   = jsString("lote");  
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objNcm.trazCampoExcel(jsNcm)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("ncm"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("NCM",retPhp[0].erro,"AVISO");    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Ncm<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
