<?php
  ...
  if( isset($_POST["cnabinstrucao"]) ){
    try{     
      ...
      $vldr     = new validaJson();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["cnabinstrucao"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectCi" ){
          ...
          $sql.="       ,A.CI_CODIGO";          
          $sql.="       ,A.CI_NOME";
          $sql.="       ,CASE WHEN A.CI_ATIVO='S' THEN 'SIM' ELSE 'NAO' END AS CI_ATIVO";
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VCNABINSTRUCAO",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        //////////////////////////////////////////
        //   Objeto clsTable2017 CNABINSTRUCAO  //
        //////////////////////////////////////////
        jsCi={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          : "CI_CODBCD" 
                      ,"pk"             : "S"
                      ,"insUpDel"       : ["S","N","N"]
                      ,"labelCol"       : "BCO"
                      ,"obj"            : "edtCodBcd"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"digitosMinMax"  : [2,6]
                      ,"ajudaCampo"     : [  "Codigo do Banco. Registro deve existir na tabela de regiao e tem o formato 0.00.0000"
                                            ,"A checagem de cada rotina é relacionada com esta informação"]
                      ,"importaExcel"   : "S"                                                                
                      ,"padrao":0}
            ,{"id":2  ,"field"          : "BCD_NOME"   
                      ,"insUpDel"       : ["N","N","N"]
                      ,"labelCol"       : "BANCO DESCRICAO"
                      ,"obj"            : "edtDesBcd"
                      ,"tamGrd"         : "20em"
                      ,"tamImp"         : "0"
                      ...
                      ,"digitosMinMax"  : [1,30]
                      ,"validar"        : ["notnull"]                      
                      ,"ajudaCampo"     : ["Descrição da Banco para esta CnabInstrucao."]
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "CI_CODIGO" 
                      ,"pk"             : "S"
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "7em"
            ...
            ,{"id":4  ,"field"          : "CI_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome da CnabInstrucao."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":5  ,"field"          : "CI_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
          ...
          [
            { "width"           :"100%"
              ,"height"         :"360px" 
              ,"label"          :"CNABINSTRUCAO - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmCi"               // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaCi"            // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmCi"               // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"       // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblCi"               // Nome da table
          ,"prefixo"        : "ci"                  // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VCNABINSTRUCAO"      // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPCNABINSTRUCAO"    // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "CI_ATIVO"            // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objCi.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objCi.AjudaSisAtivo(jsCi);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objCi.detalhe();"]
                               //,["Gerar excel"                            ,"fa-file-excel-o"  ,"objCi.excel();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objCi.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objCi.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objCi.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objCi.altRegSistema("+jsPub[0].usr_d31+");"]
                               ,["Número de registros em tela"            ,"fa-info"          ,"objCi.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "CNABINSTRUCAO[30]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objCi === undefined ){  
          objCi=new clsTable2017("objCi");
        };  
        objCi.montarHtmlCE2017(jsCi); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsCi.form).style.width=jsCi.width;
        //
        //
        ////////////////////////////////////////////////////////
      ...
      //
      var objCi;                      // Obrigatório para instanciar o JS TFormaCob
      var jsCi;                       // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectCi"                               );
        clsJs.add("login"       , jsPub[0].usr_login                        );
        clsJs.add("ativo"       , atv                                       );
        clsJs.add("codCi"       , document.getElementById("edtCodBcd").value );        
        fd = new FormData();
        fd.append("cnabinstrucao" , clsJs.fim());
        msg     = requestPedido("Trac_CnabInstrucao.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsCi.registros=objCi.addIdUnico(retPhp[0]["dados"]);
          objCi.ordenaJSon(jsCi.indiceTable,false);  
          objCi.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login          );
            clsJs.add("titulo"      , objCi.trazCampoExcel(jsCi));    
            envPhp=clsJs.fim();  
            fd = new FormData();
            fd.append("cnabinstrucao"      , envPhp            );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("CI",retPhp[0].erro,{cabec:"Aviso"});    
          };  
        } catch(e){
          ...
          <input type="hidden" id="sql" name="sql"/>
            <div class="campotexto campo100">
              ...
              <div class="campotexto campo35">
                ...
                <label class="campo_label campo_required" for="edtDesBcd">BCO_DESCRIÇÃO</label>
              </div>
              <div class="campotexto campo15">
