<?php
  ...
  if( isset($_POST["empresaregtrib"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["empresaregtrib"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectErt" ){
          $sql="SELECT ERT_CODIGO
                       ...
                       ,US_APELIDO
                       ,ERT_CODUSR
                  FROM EMPRESAREGTRIB A
                  LEFT OUTER JOIN USUARIOSISTEMA U ON A.ERT_CODUSR=U.US_CODIGO
                 WHERE (ERT_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VEMPRESAREGTRIB",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        ////////////////////////////////////////////////
        //         Objeto clsTable2017 EMPRESAREGTRIB //
        ////////////////////////////////////////////////
        jsErt={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"ERT_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do empresaregtrib conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "ERT_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do empresaregtrib com até 50 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "ERT_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":4  ,"field"          : "ERT_REG"    
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"EMPRESAREGTRIB - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmErt"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaErt"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmErt"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblErt"                  // Nome da table
          ,"prefixo"        : "ert"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VEMPRESAREGTRIB"         // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPEMPRESAREGTRIB"       // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "ERT_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "ERT_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "ERT_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "79em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "EMPRESAREGTRIB"          // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objErt.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objErt.AjudaSisAtivo(jsErt);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objErt.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objErt.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objErt.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objErt.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objErt.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"                ,"fa-info"      ,"objErt.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "EMPRESAREGTRIB[25]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objErt === undefined ){  
          objErt=new clsTable2017("objErt");
        };  
        objErt.montarHtmlCE2017(jsErt); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsErt.form).style.width=jsErt.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação empresaregtrib" // Titulo do relatório
      ...
      //
      var objErt;                     // Obrigatório para instanciar o JS TFormaCob
      var jsErt;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectErt"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("empresaregtrib" , clsJs.fim());
        msg     = requestPedido("Trac_EmpresaRegTrib.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsErt.registros=objErt.addIdUnico(retPhp[0]["dados"]);
          objErt.ordenaJSon(jsErt.indiceTable,false);  
          objErt.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objErt.trazCampoExcel(jsErt)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("empresaregtrib"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("ERT",retPhp[0].erro,{cabec:"Aviso"});    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Empresa reg trib<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
          <div style="height: 120px; overflow-y: auto;">
            ...
            <div class="campotexto campo100">
              ...
              <div class="campotexto campo75">
                <input class="campo_input" id="edtDescricao" type="text" maxlength="50" />
