    ...
    try{     
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VCARGO",0);
          //////////////////////////////////////////////////////////////////////////////////////
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        ...
        jsCrg={
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objCrg.modeloExcel()"]
                               ...
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objCrg.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"                ,"fa-info"      ,"objCrg.numRegistros();"]                               
        ...
        //////////////////////////////////    
        document.getElementById(jsCrg.form).style.width=jsCrg.width;
        //
        //
        //////////////////////////////////////////////
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("CRG",retPhp[0].erro,{cabec:"Aviso"});    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Cargo<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
