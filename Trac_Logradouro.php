<?php
  ...
  if( isset($_POST["logradouro"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["logradouro"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectLgr" ){
          $sql="SELECT LGR_CODIGO
                 ...
                 WHERE (LGR_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VLOGRADOURO",0);
          //////////////////////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////
        // Vendo se atualiza o banco de dados //
        ////////////////////////////////////////
        if( $atuBd ){
          if( count($arrUpdt) >0 ){
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        //////////////////////////////////////
        //   Objeto clsTable2017 LOGRADOURO //
        //////////////////////////////////////
        jsLgr={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"LGR_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do logradouro conforme correios. Este campo é único e deve tem o formato AAAAA"
            ...
            ,{"id":2  ,"field"          : "LGR_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do logradouro."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "LGR_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":4  ,"field"          : "LGR_REG"    
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"LOGRADOURO - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmLgr"              // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaLgr"           // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmLgr"              // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"       // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblLgr"              // Nome da table
          ,"prefixo"        : "lgr"                 // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VLOGRADOURO"         // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPLOGRADOURO"       // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "LGR_ATIVO"           // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "LGR_REG"             // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "LGR_CODUSR"          // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"         // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "77em"                // Tamanho da table
          ,"height"         : "58em"                // Altura da table
          ,"tableLeft"      : "sim"                 // Se tiver menu esquerdo
          ,"relTitulo"      : "LOGRADOURO"          // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objLgr.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objLgr.AjudaSisAtivo(jsLgr);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objLgr.detalhe();"]
                               //,["Gerar excel"                          ,"fa-file-excel-o"  ,"objLgr.excel();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objLgr.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objLgr.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objLgr.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objLgr.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"            ,"fa-info"          ,"objLgr.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "LOGRADOURO[30]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objLgr === undefined ){  
          objLgr=new clsTable2017("objLgr");
        };  
        objLgr.montarHtmlCE2017(jsLgr); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsLgr.form).style.width=jsLgr.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação logradouros"  // Titulo do relatório
        ...
        //  
        btnFiltrarClick("S");  
        //let my=parseTable(tblLgr);
      });
      //
      var objLgr;                     // Obrigatório para instanciar o JS TFormaCob
      var jsLgr;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectLgr"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("logradouro" , clsJs.fim());
        msg     = requestPedido("Trac_Logradouro.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsLgr.registros=objLgr.addIdUnico(retPhp[0]["dados"]);
          objLgr.ordenaJSon(jsLgr.indiceTable,false);  
          objLgr.montarBody2017();
        };  
      };
      //////////////////////////////////////////////////////////
      // Importar excel                                       //
      // cmpImpExcel eh um array dos campos para envio ao php //
      //////////////////////////////////////////////////////////
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objLgr.trazCampoExcel(jsLgr)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("logradouro"  , envPhp);
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("LGR",retPhp[0].erro,"AVISO");    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Logradouro<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
