<?php
  ...
  if( isset($_POST["bancocodigo"]) ){
    try{     
      ...
      $vldr     = new validaJson();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["bancocodigo"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectBcd" ){
          $sql="SELECT BCD_CODIGO
                 ...
                 WHERE (BCD_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VBANCOCODIGO",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 BANCOCODIGO //
        /////////////////////////////////////////////
        jsBcd={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"BCD_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
            ...
            ,{"id":2  ,"field"          : "BCD_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do bancocodigo com até 30 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "BCD_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":4  ,"field"          : "BCD_REG"    
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"BANCOCODIGO - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmBcd"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaBcd"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmBcd"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblBcd"                  // Nome da table
          ,"prefixo"        : "bcd"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VBANCOCODIGO"            // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPBANCOCODIGO"          // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "BCD_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "BCD_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "BCD_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "77em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "BANCO-CODIGO"            // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objBcd.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objBcd.AjudaSisAtivo(jsBcd);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objBcd.detalhe();"]
                               //,["Gerar excel"                            ,"fa-file-excel-o"  ,"objBcd.excel();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objBcd.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objBcd.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objBcd.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objBcd.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"            ,"fa-info"          ,"objBcd.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "BANCOCODIGO[06]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objBcd === undefined ){  
          objBcd=new clsTable2017("objBcd");
        };  
        objBcd.montarHtmlCE2017(jsBcd); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsBcd.form).style.width=jsBcd.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação bancocodigo"  // Titulo do relatório
      ...
      //
      var objBcd;                     // Obrigatório para instanciar o JS TFormaCob
      var jsBcd;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectBcd"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("bancocodigo" , clsJs.fim());
        msg     = requestPedido("Trac_BancoCodigo.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsBcd.registros=objBcd.addIdUnico(retPhp[0]["dados"]);
          objBcd.ordenaJSon(jsBcd.indiceTable,false);  
          objBcd.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objBcd.trazCampoExcel(jsBcd)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("bancocodigo"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("BCD",retPhp[0].erro,{cabec:"Aviso"});    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Banco Codigo<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>
