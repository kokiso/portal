<?php
  ...
  if( isset($_POST["produtoorigem"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["produtoorigem"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectPo" ){
          $sql="SELECT PO_CODIGO
                       ...
                       ,US_APELIDO
                       ,PO_CODUSR
                  FROM PRODUTOORIGEM A
                  LEFT OUTER JOIN USUARIOSISTEMA U ON A.PO_CODUSR=U.US_CODIGO
                 WHERE (PO_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VPRODUTOORIGEM",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 PRODUTOORIGEM       //
        /////////////////////////////////////////////
        jsPo={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"PO_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do produtoorigem conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "PO_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do produtoorigem com até 30 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "PO_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"PRODUTOORIGEM - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmPo"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaPo"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmPo"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblPo"                  // Nome da table
          ,"prefixo"        : "po"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VPRODUTOORIGEM"                  // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPPRODUTOORIGEM"                // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "PO_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "PO_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "PO_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "77em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "PRODUTOORIGEM"                   // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objPo.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objPo.AjudaSisAtivo(jsPo);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objPo.detalhe();"]
                               //,["Gerar excel"                          ,"fa-file-excel-o"  ,"objPo.excel();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objPo.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objPo.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objPo.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objPo.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"                ,"fa-info"      ,"objPo.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "PRODUTOORIGEM[09]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objPo === undefined ){  
          objPo=new clsTable2017("objPo");
        };  
        objPo.montarHtmlCE2017(jsPo); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsPo.form).style.width=jsPo.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação PRODUTOORIGEM"// Titulo do relatório
      ...
      //
      var objPo;                     // Obrigatório para instanciar o JS TFormaCob
      var jsPo;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectPo"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("produtoorigem" , clsJs.fim());
        msg     = requestPedido("Trac_Produtoorigem.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsPo.registros=objPo.addIdUnico(retPhp[0]["dados"]);
          objPo.ordenaJSon(jsPo.indiceTable,false);  
          objPo.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objPo.trazCampoExcel(jsPo)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("produtoorigem"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("PO",retPhp[0].erro,"AVISO");    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Produto origem<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
          <div style="height: 120px; overflow-y: auto;">
            <input type="hidden" id="sql" name="sql"/>
            <div class="campotexto campo100">
              <div class="campotexto campo25">
                <input class="campo_input" id="edtCodigo" type="text" maxlength="1" />
