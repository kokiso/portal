<?php
  ...
  if( isset($_POST["regiao"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["regiao"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectReg" ){
          $sql="SELECT A.REG_CODIGO
                  ...
                  LEFT OUTER JOIN PAIS P ON A.REG_CODPAI=P.PAI_CODIGO
                 WHERE (REG_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VREGIAO",0);
          //////////////////////////////////////////////////////////////////////////////////////
...
<!DOCTYPE html>
  <head>
    ...
    <!--<script src="tabelaTrac/f10/tabelaPaisF10.js"></script>-->
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        //////////////////////////////////////
        //   Objeto clsTable2017 REGIAO     //
        //////////////////////////////////////
        jsReg={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"REG_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do regiao conforme IBGE. Este campo é único e deve tem o formato AAAAA"
            ...
            ,{"id":2  ,"field"          : "REG_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome da região."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          :"REG_CODPAI" 
                      ,"labelCol"       : "CODPAIS"
                      ,"obj"            : "edtCodPai"
                      ,"tamGrd"         : "0em"
                      ,"tamImp"         : "0"
                      ,"fieldType"      : "int"
                      ,"align"          : "center"                                      
                      ,"newRecord"      : ["1058","this","this"]
                      ,"formato"        : ["i4"]
                      ,"validar"        : ["intMaiorZero"]
                      ,"ajudaCampo"     : [  "Codigo do Pais. Registro deve existir na tabela de pais e tem o formato 9999"
            ...
            ,{"id":4  ,"field"          : "PAI_NOME"   
                      ...
                      ,"tamGrd"         : "20em"
                      ,"tamImp"         : "60"
                      ,"newRecord"      : ["BRASIL","this","this"]
                      ,"digitosMinMax"  : [1,30]
                      ,"validar"        : ["notnull"]                      
                      ,"ajudaCampo"     : ["Descrição do pais para esta regiao."]
                      ,"padrao":0}
            ,{"id":5  ,"field"          : "REG_ATIVO"  
                      ,"labelCol"       : "ATIVO"  
                      ,"tamImp"         : "12"                      
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
          ...
          [
            { "width"           :"100%"
              ,"height"         :"330px" 
              ,"label"          :"REGIÃO - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmReg"              // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaReg"           // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmReg"              // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"       // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblReg"              // Nome da table
          ,"prefixo"        : "reg"                 // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VREGIAO"             // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPREGIAO"           // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "REG_ATIVO"           // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "REG_REG"             // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "REG_CODUSR"          // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"         // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "87em"                // Tamanho da table
          ,"height"         : "58em"                // Altura da table
          ,"tableLeft"      : "sim"                 // Se tiver menu esquerdo
          ,"relTitulo"      : "REGIAO"              // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objReg.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objReg.AjudaSisAtivo(jsReg);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objReg.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objReg.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objReg.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objReg.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objReg.altRegSistema("+jsPub[0].usr_d31+");"]
                               ,["Número de registros em tela"            ,"fa-info"          ,"objReg.numRegistros();"]                               
        ...
        if( objReg === undefined ){  
          objReg=new clsTable2017("objReg");
        };  
        objReg.montarHtmlCE2017(jsReg); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsReg.form).style.width=jsReg.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          "titulo":[
            ...
            ,{"id":2  ,"field":"CODPAI"     ,"labelCol":"CODPAIS"   ,"tamGrd":"6em"  ,"tamImp":"20"}
      ...
      //
      var objReg;                     // Obrigatório para instanciar o JS TFormaCob
      var jsReg;                      // Obj principal da classe clsTable2017
      var objExc;                     // Obrigatório para instanciar o JS Importar excel
      var jsExc;                      // Obrigatório para instanciar o objeto objExc
      //var objPaiF10;                  // Obrigatório para instanciar o JS PaisF10          
      var objPadF10;                  // Obrigatório para instanciar o JS PaisF10          
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectReg"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("regiao" , clsJs.fim());
        msg     = requestPedido("Trac_Regiao.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsReg.registros=objReg.addIdUnico(retPhp[0]["dados"]);
          objReg.ordenaJSon(jsReg.indiceTable,false);  
          objReg.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login          );
            clsJs.add("titulo"      , objReg.trazCampoExcel(jsReg));    
            envPhp=clsJs.fim();  
            fd = new FormData();
            fd.append("regiao"  , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("REG",retPhp[0].erro,"AVISO");    
          };  
        } catch(e){
      ...
      //  AJUDA PARA PAIS  //
      ///////////////////////
      function paiFocus(obj){ 
        document.getElementById(obj.id).setAttribute("data-oldvalue",document.getElementById(obj.id).value); 
      };
      function paiF10Click(obj){ 
        fPadraoF10( { opc:0
                      ,edtCod:obj.id
                      ,foco:"cbAtivo"
                      ,topo:100
                      ,tableBd:"PAIS"
                      ,fieldCod:"A.PAI_CODIGO"
                      ,fieldDes:"A.PAI_NOME"
                      ,fieldAtv:"A.PAI_ATIVO"
                      ,typeCod :"int" }
        );
      };
      function RetF10tblPad(arr){
        document.getElementById("edtCodPai").value  = arr[0].CODIGO;
        document.getElementById("edtDesPai").value  = arr[0].DESCRICAO;
        document.getElementById("edtCodPai").setAttribute("data-oldvalue",arr[0].CODIGO);
      };
      function codPaiBlur(obj){
        ...
        if( elOld != elNew ){
          ...
          document.getElementById("edtDesPai").value  = ( ret.length == 0 ? ""      : ret[0].DESCRICAO                      );
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Região<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
          ...
          <input type="hidden" id="sql" name="sql"/>
            <div class="campotexto campo100">
              ...
              <div class="campotexto campo15">
                <input class="campo_input inputF10" id="edtCodPai"
                                                    OnKeyPress="return mascaraInteiro(event);"
                                                    onBlur="codPaiBlur(this);" 
                                                    onFocus="paiFocus(this);" 
                                                    onClick="paiF10Click(this);"
                                                    data-oldvalue="0000" 
                                                    autocomplete="off"
                                                    type="text" />
                <label class="campo_label campo_required" for="edtCodPai">PAIS:</label>
              </div>
              <div class="campotexto campo35">
                <input class="campo_input_titulo input" id="edtDesPai" type="text" disabled />
                <label class="campo_label campo_required" for="edtDesPai">NOME_PAIS:</label>
              </div>
