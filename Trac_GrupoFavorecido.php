<?php
  session_start();
  if( isset($_POST["grupofavorecido"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["grupofavorecido"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectGf" ){
          $sql="SELECT GF_CODIGO
                       ...
                       ,US_APELIDO
                       ,GF_CODUSR
                  FROM GRUPOFAVORECIDO A
                  LEFT OUTER JOIN USUARIOSISTEMA U ON A.GF_CODUSR=U.US_CODIGO
                 WHERE (GF_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VGRUPOFAVORECIDO",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 GRUPOFAVORECIDO       //
        /////////////////////////////////////////////
        jsGf={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"GF_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "4em"
                      ,"tamImp"         : "15"
                      ...
                      ,"autoIncremento" : "S"
                      ,"ajudaCampo"     : [  "Codigo do GRUPOFAVORECIDO. Gerado pelo sistema é único e tem o formato 9999"
            ...
            ,{"id":2  ,"field"          : "GF_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do GRUPOFAVORECIDO com até 40 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "GF_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"GRUPOFAVORECIDO - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmGf"                   // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaGf"                // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmGf"                   // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblGf"                   // Nome da table
          ,"prefixo"        : "gf"                      // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VGRUPOFAVORECIDO"        // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPGRUPOFAVORECIDO"      // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "GF_ATIVO"                // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "GF_REG"                  // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "GF_CODUSR"               // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "88em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "GRUPOFAVORECIDO"         // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objGf.modeloExcel()"]                               
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objGf.AjudaSisAtivo(jsGf);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objGf.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objGf.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objGf.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objGf.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objGf.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"            ,"fa-info"          ,"objGf.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "GRUPOFAVORECIDO[11]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objGf === undefined ){  
          objGf=new clsTable2017("objGf");
        };  
        objGf.montarHtmlCE2017(jsGf); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsGf.form).style.width=jsGf.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Grupo Favorecido"        // Titulo do relatório
      ...
      //
      var objGf;                      // Obrigatório para instanciar o JS TFormaCob
      var jsGf;                       // Obj principal da classe clsTable2017
      ...
      var intCodDir = parseInt(jsPub[0].usr_d11);
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectGf"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("grupofavorecido" , clsJs.fim());
        msg     = requestPedido("Trac_Grupofavorecido.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsGf.registros=objGf.addIdUnico(retPhp[0]["dados"]);
          objGf.ordenaJSon(jsGf.indiceTable,false);  
          objGf.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objGf.trazCampoExcel(jsGf)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("grupofavorecido"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("GF",retPhp[0].erro,"AVISO");    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Grupo favorecido<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
