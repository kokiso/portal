<?php
  ...
  if( isset($_POST["vendedor"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["vendedor"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        ////////////////////////////////////////////////
        if( $rotina=="selectVnd" ){
          $sql="SELECT A.VND_CODFVR
                       ,A.VND_CODEMP                                 
                       ,FVR.FVR_NOME
                       ,A.VND_CODLGN
                       ,LGN.USR_APELIDO AS LGN_NOME
                       ...
                       ,A.VND_CODUSR
                  FROM VENDEDOR A
                  LEFT OUTER JOIN FAVORECIDO FVR ON A.VND_CODFVR=FVR.FVR_CODIGO
                  LEFT OUTER JOIN USUARIO LGN ON A.VND_CODLGN=LGN.USR_CODIGO                  
                  LEFT OUTER JOIN USUARIOSISTEMA US ON A.VND_CODUSR=US.US_CODIGO
                 WHERE ((VND_CODEMP=".$lote[0]->codemp.")
                   AND ((VND_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')))";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VVENDEDOR",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 VENDEDOR    //
        /////////////////////////////////////////////
        jsVnd={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"VND_CODFVR" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodFvr"
                      ,"tamGrd"         : "4em"
                      ,"tamImp"         : "15"
                      ...
                      ,"ajudaCampo"     : [  "Codigo do vendedor conforme definição empresa. Este campo é único e deve tem o formato AAA"
                                            ,"Campo pode ser utilizado em cadastros de Usuario/Motorista"]
                      ,"importaExcel"   : "S"                                                                
                      ,"padrao":0}
            ,{"id":2  ,"field"          : "VND_CODEMP" 
                      ,"pk"             : "S"
                      ,"labelCol"       : "CODEMP"  
                      ,"obj"            : "edtCodEmp"  
                      ,"padrao":7}  
            ,{"id":3  ,"field"          : "FVR_NOME"
                      ...
                      ,"tamImp"         : "100"
                      ,"digitosMinMax"  : [3,60]
                      ,"ajudaCampo"     : ["Nome do vendedor com até 60 caracteres."]
                      ,"importaExcel"   : "N"                                          
                      ,"padrao":0}
            ,{"id":4  ,"field"          :"VND_CODLGN" 
                      ,"labelCol"       : "CODLGN"
                      ,"obj"            : "edtCodLgn"
                      ,"tamGrd"         : "0em"
                      ,"tamImp"         : "0"
                      ...
                      ,"insUpDel"       : ["S","S","N"]
                      ,"validar"        : ["intMaiorZero"]
                      ,"ajudaCampo"     : [  "Codigo do usuario relacionado com este vendedor"]
                      ,"importaExcel"   : "S"                                                                
                      ,"padrao":0}
            ,{"id":5  ,"field"          : "LGN_NOME"
                      ,"insUpDel"       : ["N","N","N"]            
                      ...
                      ,"tamImp"         : "30"
                      ,"digitosMinMax"  : [1,15]
                      ,"ajudaCampo"     : ["Login vinculado ao vendedor."]
                      ,"popoverTitle"   : "Faz o vinculo entre usuario logado com vendedor do pedido"                          
                      ,"popoverLabelCol": "Login"                      
                      ,"importaExcel"   : "N"                                          
                      ,"padrao":0}
            ,{"id":6  ,"field"          : "VND_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":7  ,"field"          : "VND_REG"    
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"VENDEDOR - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmVnd"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaVnd"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmVnd"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblVnd"                  // Nome da table
          ,"prefixo"        : "vnd"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VVENDEDOR"               // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPVENDEDOR"             // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "VND_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "VND_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "VND_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "98em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "VENDEDOR"                   // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objVnd.AjudaSisAtivo(jsVnd);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objVnd.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objVnd.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objVnd.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objVnd.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objVnd.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"            ,"fa-info"          ,"objVnd.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "VENDEDOR[29]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objVnd === undefined ){  
          objVnd=new clsTable2017("objVnd");
        };  
        objVnd.montarHtmlCE2017(jsVnd); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsVnd.form).style.width=jsVnd.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          "titulo":[
            ...
            ,{"id":1  ,"field":"CODLGN"     ,"labelCol":"CODLGN"    ,"tamGrd":"6em"  ,"tamImp":"20"}
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação vendedor"     // Titulo do relatório
      ...
      //
      var objVnd;                     // Obrigatório para instanciar o JS TFormaCob
      var jsVnd;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectVnd"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("codemp"      , jsPub[0].emp_codigo );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("vendedor" , clsJs.fim());
        msg     = requestPedido("Trac_Vendedor.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsVnd.registros=objVnd.addIdUnico(retPhp[0]["dados"]);
          objVnd.ordenaJSon(jsVnd.indiceTable,false);  
          objVnd.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objVnd.trazCampoExcel(jsVnd)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("vendedor"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("VND",retPhp[0].erro,"AVISO");    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Vendedor<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>                            
          <div style="height: 140px; overflow-y: auto;">
            ...
            <div class="campotexto campo100">
              ...
              <div class="campotexto campo100">
                <label class="labelMensagem" for="edtUsuario">- Login obrigatório para relacionamento vendedor/usuario que se logou no sistema</label>
              </div>
            </div>
          </div>
        </form>
