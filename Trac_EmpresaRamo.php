<?php
  ...
  if( isset($_POST["empresaramo"]) ){
    try{     
      ...
      $vldr     = new validaJson();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["empresaramo"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectErm" ){
          $sql="SELECT ERM_CODIGO
                 ...
                 WHERE (ERM_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VEMPRESARAMO",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 EMPRESARAMO //
        /////////////////////////////////////////////
        jsErm={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"ERM_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do empresaramo conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "ERM_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do empresaramo com até 25 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "ERM_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":4  ,"field"          : "ERM_REG"    
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"EMPRESARAMO - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmErm"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaErm"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmErm"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblErm"                  // Nome da table
          ,"prefixo"        : "erm"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VEMPRESARAMO"            // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPEMPRESARAMO"          // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "ERM_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "ERM_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "ERM_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "77em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "EMPRESA->RAMO"           // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objErm.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objErm.AjudaSisAtivo(jsErm);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objErm.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objErm.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objErm.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objErm.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objErm.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"                ,"fa-info"      ,"objErm.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "EMPRESARAMO[25]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objErm === undefined ){  
          objErm=new clsTable2017("objErm");
        };  
        objErm.montarHtmlCE2017(jsErm); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsErm.form).style.width=jsErm.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação EMPRESARAMO"  // Titulo do relatório
      ...
      //
      var objErm;                     // Obrigatório para instanciar o JS TFormaCob
      var jsErm;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectErm"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("empresaramo" , clsJs.fim());
        msg     = requestPedido("Trac_EmpresaRamo.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsErm.registros=objErm.addIdUnico(retPhp[0]["dados"]);
          objErm.ordenaJSon(jsErm.indiceTable,false);  
          objErm.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objErm.trazCampoExcel(jsErm)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("empresaramo"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("ERM",retPhp[0].erro,{cabec:"Aviso"});    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Empresa-ramo<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
