<?php
  ...
  if( isset($_POST["sped"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["sped"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectSpd" ){
          $sql="SELECT SPD_CODIGO
                 ...
                 WHERE (SPD_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VSPED",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 SPED       //
        /////////////////////////////////////////////
        jsSpd={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"SPD_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "5em"
                      ,"tamImp"         : "15"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo do sped conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "SPD_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome do sped com até 20 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "SPD_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":4  ,"field"          : "SPD_REG"    
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"SPED - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmSpd"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaSpd"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmSpd"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblSpd"                  // Nome da table
          ,"prefixo"        : "spd"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VSPED"                   // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPSPED"                 // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "SPD_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "SPD_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "SPD_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "75em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "SPED"                    // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objSpd.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objSpd.AjudaSisAtivo(jsSpd);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objSpd.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objSpd.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objSpd.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objSpd.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objSpd.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"            ,"fa-info"          ,"objSpd.numRegistros();"]                               
        ...
        if( objSpd === undefined ){  
          objSpd=new clsTable2017("objSpd");
        };  
        objSpd.montarHtmlCE2017(jsSpd); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsSpd.form).style.width=jsSpd.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação SPED"// Titulo do relatório
      ...
      //
      var objSpd;                     // Obrigatório para instanciar o JS TFormaCob
      var jsSpd;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectSpd"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("sped" , clsJs.fim());
        msg     = requestPedido("Trac_Sped.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsSpd.registros=objSpd.addIdUnico(retPhp[0]["dados"]);
          objSpd.ordenaJSon(jsSpd.indiceTable,false);  
          objSpd.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objSpd.trazCampoExcel(jsSpd)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("sped"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("SPD",retPhp[0].erro,"AVISO");    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Sped<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
