...
function clsTable2017(obj) { 
  ...
  this.montarHtmlCE2017=function(parJS){
    ...
    ceInput.type          = "text";
    ceInput.name          = "txtProcurar_"+(self.Js.div == undefined ? self.Js.prefixo : self.Js.div);
    ceInput.id            = "txtProcurar_"+(self.Js.div == undefined ? self.Js.prefixo : self.Js.div);
      ...
      ceButton.addEventListener('click',function(){
        try{
          ...
          for( var checados=0; checados<tamC; checados++ ){  
            ///////////////////////////////////////////////////////////////////
            // Aqui tenho a opcao de escolher onde estao as func de retorno  //
            // "_" usa funcs do proprio arquivo da classe(tabelaXXXXXF10.js) //
            // Usa funcs do arquivo principal usado na tela                  //
            ///////////////////////////////////////////////////////////////////
    ...
    self.Js.titulo.forEach(function(reg,lin){
      switch(self.Js.titulo[lin].padrao){
        ...
        case 8: // imagem do passo-a-passo
          ...
          self.Js.titulo[lin].popoverLabelCol="Ajuda";
          self.Js.titulo[lin].popoverTitle="Passo a passo do registro";
          break;
  ...
  this.ordenaJSon=function(strCol,refazBody,ordena){
    ...
    //var coluna  = ( strCol==undefined ? strCol : self.Js.indiceTable ); 
    var tam     = (self.Js.titulo).length;
    var reg;
    var datA;
    var datB;  
