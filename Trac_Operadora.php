<?php
  ...
  if( isset($_POST["operadora"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["operadora"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectOpe" ){
          $sql="SELECT OPE_CODFVR
                       ...
                       ,OPE_CODUSR
                  FROM OPERADORA A
                  LEFT OUTER JOIN FAVORECIDO FVR ON A.OPE_CODFVR=FVR.FVR_CODIGO
                  LEFT OUTER JOIN USUARIOSISTEMA U ON A.OPE_CODUSR=U.US_CODIGO
                 WHERE ((OPE_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."'))";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VOPERADORA",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //         Objeto clsTable2017 OPERADORA   //
        /////////////////////////////////////////////
        jsOpe={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"OPE_CODFVR" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodFvr"
                      ,"tamGrd"         : "4em"
                      ,"tamImp"         : "15"
                      ...
                      ,"ajudaCampo"     : [  "Codigo do operadora conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "FVR_NOME"
                      ...
                      ,"tamImp"         : "120"
                      ,"digitosMinMax"  : [3,60]
                      ,"ajudaCampo"     : ["Nome do operadora com até 60 caracteres."]
                      ,"importaExcel"   : "N"                                          
                      ,"padrao":0}
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"OPERADORA - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmOpe"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaOpe"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmOpe"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblOpe"                  // Nome da table
          ,"prefixo"        : "Ope"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VOPERADORA"              // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPOPERADORA"            // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "OPE_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "OPE_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "OPE_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "100em"                   // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "OPERADORA"               // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objOpe.AjudaSisAtivo(jsOpe);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objOpe.detalhe();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objOpe.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objOpe.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objOpe.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objOpe.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"            ,"fa-info"          ,"objOpe.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "OPERADORA[33]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objOpe === undefined ){  
          objOpe=new clsTable2017("objOpe");
        };  
        objOpe.montarHtmlCE2017(jsOpe); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsOpe.form).style.width=jsOpe.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação operadora"    // Titulo do relatório
      ...
      //
      var objOpe;                     // Obrigatório para instanciar o JS TFormaCob
      var jsOpe;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectOpe"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("operadora" , clsJs.fim());
        msg     = requestPedido("Trac_Operadora.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsOpe.registros=objOpe.addIdUnico(retPhp[0]["dados"]);
          objOpe.ordenaJSon(jsOpe.indiceTable,false);  
          objOpe.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objOpe.trazCampoExcel(jsOpe)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("operadora"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("Ope",retPhp[0].erro,"AVISO");    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Operadora<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>                            
