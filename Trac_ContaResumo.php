<?php
  ...
  if( isset($_POST["contaresumo"]) ){
    try{     
      ...
      $vldr     = new validaJSon();          
      $retorno  = "";
      $retCls   = $vldr->validarJs($_POST["contaresumo"]);
      ///////////////////////////////////////////////////////////////////////
      ...
      if($retCls["retorno"] != "OK"){
        ...
        if( $rotina=="selectCtr" ){
          $sql="SELECT CTR_CODIGO
                 ...
                 WHERE (CTR_ATIVO='".$lote[0]->ativo."') OR ('*'='".$lote[0]->ativo."')";                 
        ...
        if( $rotina=="impExcel" ){
          ...
          $vldCampo = new validaCampo("VCONTARESUMO",0);
          //////////////////////////////////////////////////////////////////////////////////////
  ...
  <head>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){ 
        /////////////////////////////////////////////
        //    Objeto clsTable2017 CONTARESUMO      //
        /////////////////////////////////////////////
        jsCtr={
          "titulo":[
             {"id":0  ,"labelCol":"OPC"     
                      ,"padrao":1}            
            ,{"id":1  ,"field"          :"CTR_CODIGO" 
                      ,"labelCol"       : "CODIGO"
                      ,"obj"            : "edtCodigo"
                      ,"tamGrd"         : "9em"
                      ,"tamImp"         : "18"
                      ...
                      ,"validar"        : ["notnull"]
                      ,"ajudaCampo"     : [  "Codigo da conta resumo conforme definição empresa. Este campo é único e deve tem o formato AAA"
            ...
            ,{"id":2  ,"field"          : "CTR_NOME"   
                      ...
                      ,"ajudaCampo"     : ["Nome da conta resumo com até 20 caracteres."]
                      ,"importaExcel"   : "S"                                          
                      ,"padrao":0}
            ,{"id":3  ,"field"          : "CTR_ATIVO"  
                      ,"labelCol"       : "ATIVO"   
                      ,"obj"            : "cbAtivo"    
                      ,"padrao":2}                                        
            ,{"id":4  ,"field"          : "CTR_REG"    
          ...
          [
            { "width"           :"100%"
              ,"height"         :"300px" 
              ,"label"          :"CONTARESUMO - Detalhe do registro"
            }
          ]
          , 
          "botoesH":[
          ...
          ,"div"            : "frmCtr"                  // Onde vai ser gerado a table
          ,"divFieldSet"    : "tabelaCtr"               // Para fechar a div onde estão os fieldset ao cadastrar
          ,"form"           : "frmCtr"                  // Onde vai ser gerado o fieldSet       
          ,"divModal"       : "divTopoInicio"           // Onde vai se appendado abaixo deste a table 
          ,"tbl"            : "tblCtr"                  // Nome da table
          ,"prefixo"        : "Ctr"                     // Prefixo para elementos do HTML em jsTable2017.js
          ,"tabelaBD"       : "VCONTARESUMO"            // Nome da tabela no banco de dados  
          ,"tabelaBKP"      : "BKPCONTARESUMO"          // Nome da tabela no banco de dados  
          ,"fieldAtivo"     : "CTR_ATIVO"               // SE EXISITIR - Nome do campo ATIVO(S/N) na tabela BD
          ,"fieldReg"       : "CTR_REG"                 // SE EXISITIR - Nome do campo SYS(P/A) na tabela BD            
          ,"fieldCodUsu"    : "CTR_CODUSR"              // SE EXISITIR - Nome do campo CODIGO USUARIO na tabela BD                        
          ,"iFrame"         : "iframeCorpo"             // Se a table vai ficar dentro de uma tag iFrame
          ,"width"          : "88em"                    // Tamanho da table
          ,"height"         : "58em"                    // Altura da table
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "CONTARESUMO"             // Titulo do relatório
          ...
          ,"_menuTable"     :[
                               ...
                               ,["Modelo planilha excel"                  ,"fa-file-excel-o"  ,"objCtr.modeloExcel()"]
                               ,["Ajuda para campos padrões"              ,"fa-info"          ,"objCtr.AjudaSisAtivo(jsCtr);"]
                               ,["Detalhe do registro"                    ,"fa-folder-o"      ,"objCtr.detalhe();"]
                               //,["Gerar excel"                            ,"fa-file-excel-o"  ,"objCtr.excel();"]
                               ,["Passo a passo do registro"              ,"fa-binoculars"    ,"objCtr.espiao();"]
                               ,["Alterar status Ativo/Inativo"           ,"fa-share"         ,"objCtr.altAtivo(intCodDir);"]
                               ,["Alterar registro PUBlico/ADMinistrador" ,"fa-reply"         ,"objCtr.altPubAdm(intCodDir,jsPub[0].usr_admpub);"]
                               ,["Alterar para registro do SISTEMA"       ,"fa-reply"         ,"objCtr.altRegSistema("+jsPub[0].usr_d31+");"] 
                               ,["Número de registros em tela"                ,"fa-info"      ,"objCtr.numRegistros();"]                               
                               ,["Atualizar grade consulta"               ,"fa-filter"        ,"btnFiltrarClick('S');"]                               
                             ]  
          ,"codTblUsu"      : "CONTARESUMO[13]"                          
          ,"codDir"         : intCodDir
        }; 
        if( objCtr === undefined ){  
          objCtr=new clsTable2017("objCtr");
        };  
        objCtr.montarHtmlCE2017(jsCtr); 
        //////////////////////////////////
        // Definindo o form de manutencaum
        //////////////////////////////////    
        document.getElementById(jsCtr.form).style.width=jsCtr.width;
        //
        //
        //////////////////////////////////////////////
        ...
        jsExc={
          ...
          ,"tableLeft"      : "sim"                     // Se tiver menu esquerdo
          ,"relTitulo"      : "Importação contaresumo"  // Titulo do relatório
      ...
      //
      var objCtr;                     // Obrigatório para instanciar o JS TFormaCob
      var jsCtr;                      // Obj principal da classe clsTable2017
      ...
      function btnFiltrarClick(atv) { 
        clsJs   = jsString("lote");  
        clsJs.add("rotina"      , "selectCtr"         );
        clsJs.add("login"       , jsPub[0].usr_login  );
        clsJs.add("ativo"       , atv                 );
        fd = new FormData();
        fd.append("contaresumo" , clsJs.fim());
        msg     = requestPedido("Trac_ContaResumo.php",fd); 
        ...
        if( retPhp[0].retorno == "OK" ){
          ...
          //////////////////////////////////////////////////////////////////////////////////
          jsCtr.registros=objCtr.addIdUnico(retPhp[0]["dados"]);
          objCtr.ordenaJSon(jsCtr.indiceTable,false);  
          objCtr.montarBody2017();
        };  
      };
      ////////////////////
      // Importar excel //
      ...
      function btnAbrirExcelClick(){
        try{
          ...
          if( clsErro.ListaErr() != "" ){
            ...
            clsJs.add("login"       , jsPub[0].usr_login            );
            clsJs.add("titulo"      , objCtr.trazCampoExcel(jsCtr)  );
            envPhp=clsJs.fim();
            fd = new FormData();
            fd.append("contaresumo"   , envPhp              );
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            gerarMensagemErro("Ctr",retPhp[0].erro,{cabec:"Aviso"});    
          };  
        } catch(e){
    ...
    <div class="divTelaCheia">
      <div id="divRotina" class="conteudo">  
        ...
        <form method="post" 
              ...
              target="_newpage">
          <div class="frmTituloManutencao">Conta resumo<img class="frmTituloManutencaoImg" src="imagens\chave.png" title="campo obrigatório" /></div>          
